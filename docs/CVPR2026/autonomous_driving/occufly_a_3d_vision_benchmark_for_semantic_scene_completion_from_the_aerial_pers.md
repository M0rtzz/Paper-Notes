...
description: >-
  [CVPR 2026 (Oral)][自动驾驶][语义场景补全] OccuFly 提出了首个真实世界航拍视角的相机基语义场景补全（SSC）基准数据集，包含 2 万+ 样本、21 个语义类别，覆盖多季节多海拔的城市/工业/农村场景，并揭示了当前视觉基础模型在航拍场景下的根本局限。 领域现状：语义场景补全（Semantic Sc…
tags:
  - "CVPR 2026 (Oral)"
  - "自动驾驶"
  - "语义场景补全"
