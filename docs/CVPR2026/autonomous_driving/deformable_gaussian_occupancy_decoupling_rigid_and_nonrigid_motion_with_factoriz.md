...
- [\[CVPR 2026\] When Does Adaptive Guidance Help? Belief-Aware Privileged Distillation for Autonomous Driving Under Partial Observability](when_does_adaptive_guidance_help_belief-aware_privileged_distillation_for_autono.md)
