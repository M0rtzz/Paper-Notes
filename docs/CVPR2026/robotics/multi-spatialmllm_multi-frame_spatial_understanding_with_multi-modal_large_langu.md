...
description: >-
  [CVPR 2026][机器人][多帧空间理解] 针对 MLLM 只会单图空间推理、连左右都分不清的问题，本文用已标注的 3D/4D 场景数据集自动生成 2700 万条多帧空间问答（MultiSPA），把深度、视觉对应、动态感知三大基础能力灌进 InternVL2，训出的 Multi-SpatialMLLM 在自建 benchmark 上平均比基座涨 36%，甚至追平闭源大模型和专用 3D 模型。
tags:
  - "CVPR 2026"
  - "机器人"
  - "多帧空间理解"
...
- [\[ICLR 2026\] TPRU: Advancing Temporal and Procedural Understanding in Large Multimodal Models](../../ICLR2026/robotics/tpru_advancing_temporal_and_procedural_understanding_in_large_multimodal_models.md)
