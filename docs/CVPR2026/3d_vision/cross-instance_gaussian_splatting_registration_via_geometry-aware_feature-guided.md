...
**1. Feature-augmented 3DGS：给每个高斯挂一个几何感知特征，让配准不再只靠几何**
...
**2. Coarse Alignment：把特征约束塞进 ICP，一次性解掉初始化、尺度、跨实例三个老问题**
...
**3. Fine Alignment：用多视角特征场一致性，把 iNeRF 从"估相机位姿"推广到"配两个场"**
