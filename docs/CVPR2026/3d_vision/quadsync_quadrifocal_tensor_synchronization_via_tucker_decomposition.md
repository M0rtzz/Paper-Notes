...
- [\[ICML 2026\] Topology-Preserving Neural Operator Learning via Hodge Decomposition](../../ICML2026/3d_vision/topology-preserving_neural_operator_learning_via_hodge_decomposition.md)
