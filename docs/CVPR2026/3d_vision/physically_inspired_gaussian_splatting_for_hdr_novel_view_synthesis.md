...
description: >-
  [CVPR 2026][3D视觉][HDR重建] 提出PhysHDR-GS，通过将高斯颜色分解为固有反射率和可调环境光照，结合IE分支(曝光调制)和GI分支(光照调制)捕获互补HDR细节，跨分支HDR一致性损失提供显式HDR监督，光照引导梯度缩放缓解曝光偏差梯度饥饿，比HDR-GS提升2.04dB且76FPS实时。
tags:
  - CVPR 2026
  - 3D视觉
  - HDR重建
