...
description: >-
  [CVPR 2026][语义分割][半监督学习] 本文提出SemiTooth框架，通过多教师-多学生架构和更严格的加权置信度约束（SWC），解决多源CBCT数据在半监督牙齿分割中的分布差异问题，在构建的MS3Toothset数据集上取得SOTA。 1. 领域现状：CBCT（锥束CT）牙齿结构分割是临床口腔诊疗的基础任务…
tags:
  - "CVPR 2026"
  - "语义分割"
  - "半监督学习"
