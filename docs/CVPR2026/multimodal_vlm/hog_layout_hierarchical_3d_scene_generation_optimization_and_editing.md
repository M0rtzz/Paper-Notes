...
**3. 文本驱动的场景编辑：让场景生成从"一次性出图"变成可迭代设计**
...
### 损失函数 / 训练策略
无训练。统一使用 GPT-4o 作为 LLM/VLM 骨干。物体检索综合 SBERT 文本相似度、OpenCLIP 图文相似度和尺寸匹配度的加权分数来选取最贴合的 3D 模型。
