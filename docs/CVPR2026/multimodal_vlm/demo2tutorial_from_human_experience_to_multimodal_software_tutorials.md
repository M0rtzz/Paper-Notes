...
- [\[CVPR 2026\] Reasoning for Mobile User Experience with Multimodal LLMs: Task, Benchmark, and Approach](reasoning_for_mobile_user_experience_with_multimodal_llms_task_benchmark_and_app.md)
