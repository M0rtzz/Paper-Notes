...
description: >-
  [ICML 2025][人体理解][LLM评测基准] 提出 AAAR-1.0 基准，通过公式推断、实验设计、论文弱点发现、审稿质量鉴别四个专家级任务，系统评估 LLM 辅助科研的真实能力，揭示当前模型在深度研究任务上仍有显著不足。
tags:
  - ICML 2025
  - 人体理解
  - LLM评测基准
...
- [\[NeurIPS 2025\] Power Ensemble Aggregation for Improved Extreme Event AI Prediction](../../NeurIPS2025/human_understanding/power_ensemble_aggregation_for_improved_extreme_event_ai_prediction.md)
