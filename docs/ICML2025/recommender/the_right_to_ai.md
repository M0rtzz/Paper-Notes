...
description: >-
  [ICML 2025][推荐系统][AI治理] 本文是一篇 position paper，提出"AI 权利"（Right to AI）的概念，主张受 AI 系统影响的个人和社区应当有权参与 AI 的开发和治理，并借鉴城市规划中"城市权利"理论，构建了一个四层公民参与模型。 AI 系统正日益渗透到医疗、教育、金融、城市规划等关…
tags:
  - "ICML 2025"
  - "推荐系统"
  - "AI治理"
