...
description: >-
  [ICML2025 Oral][可解释性][决策树优化] 提出 SPLIT 算法族，通过在决策树根部附近做全局最优搜索、叶节点附近用贪心策略的混合方案，实现比全局最优方法快 100 倍以上且精度几乎无损的决策树构建。 决策树是可解释机器学习的核心模型。传统方法两极分化： - 贪心方法：（CART、C4.5）：速度快（线性复杂…
tags:
  - "ICML2025 Oral"
  - "可解释性"
  - "决策树优化"
