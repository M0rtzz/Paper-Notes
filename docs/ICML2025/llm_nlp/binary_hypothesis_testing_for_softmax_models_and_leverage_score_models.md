...
description: >-
  [ICML 2025][LLM 其他][二元假设检验] 从理论角度研究Softmax模型和Leverage Score模型的二元假设检验问题，建立了在能量约束下区分两个参数化模型所需的查询次数的紧界，与理解LLM不同能力域的区分性问题相关。 领域现状 领域现状：LLM的训练成本高昂，且对其推理能力在不同领域的表现存在不确定性…
tags:
  - "ICML 2025"
  - "LLM 其他"
  - "二元假设检验"
