...
description: >-
  [ICML2025][3D视觉][人体网格恢复] 将DPO思想引入扩散式人体网格恢复(HMR)：训练HMR-Scorer评估预测质量，构建偏好数据集(winner/loser对)，用DPO微调基座扩散模型，无需3D标注即可提升in-the-wild图像上的HMR性能。 概率式HMR的缺陷 确定性HMR产生单一预测…
tags:
  - "ICML2025"
  - "3D视觉"
  - "人体网格恢复"
