...
description: >-
  [ICML2025][强化学习][off-policy evaluation] 本文从理论上揭示了"在 OPE 中使用估计的历史依赖行为策略比使用真实行为策略反而更好"这一悖论的根本原因——估计行为策略隐式地将 IS 估计器投影到更约束的空间，降低渐近方差但增加有限样本偏差。 - Off-Policy Evaluation…
tags:
  - "ICML2025"
  - "强化学习"
