...
description: >-
  [ICML 2025][强化学习][Active Feature Acquisition] 本文提出 SEFA (Stochastic Encodings for Feature Acquisition)，一种基于随机潜变量模型的主动特征获取方法，通过在正则化潜空间中跨多种未观测特征实现进行推理来替代 RL 和贪心 CMI 最大化，在合成和真实数据集（含癌症分类）上一致超越所有基线。
tags:
  - "ICML 2025"
  - "强化学习"
