...
description: >-
  [ICML2025][强化学习][安全证书] 提出基于概率空间不变性条件的安全证书设计方法，利用因果强化学习从含潜变量的离线数据中学习边际化 Q 函数，在离线与在线统计分布不一致的情况下仍能保证长期安全性，并证明了安全动作的持续可行性。 在自动驾驶等场景中，系统常受到不可观测的潜变量：$W_t$（如路面湿滑程度、行人意图）的…
tags:
  - "ICML2025"
  - "强化学习"
  - "安全证书"
