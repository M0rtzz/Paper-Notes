...
description: >-
  [ICML 2025][医学图像][多模态] I2MoE 提出了一种可解释的多模态交互感知混合专家框架，通过四种交互专家（唯一性×2 + 协同 + 冗余）结合弱监督交互损失显式建模模态间的异质交互，并通过重加权模型提供样本级和数据集级的可解释性，在 ADNI 数据集上提升准确率 5.5%。 领域现状：多模态融合是多模态学习的…
tags:
  - "ICML 2025"
  - "医学图像"
  - "多模态"
