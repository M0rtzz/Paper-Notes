...
description: >-
  [ICML2025][预训练][解释引导学习] 提出一种用简单解释信号（重要输入特征）引导机器学习的方法——通过交替优化预测准确率和注意力对齐的两阶段训练循环，在小数据、类不平衡、虚假特征场景下显著提升性能和稳定性。 小数据的根本困境 1. 相同数据+相同算法可以产生准确率相似但决策函数完全不同的模型 2. 模型倾向于学习虚…
tags:
  - "ICML2025"
  - "预训练"
  - "解释引导学习"
