...
- [\[AAAI 2026\] Lost in Translation? A Comparative Study on the Cross-Lingual Transfer of Composite Harms](../../AAAI2026/object_detection/lost_in_translation_a_comparative_study_on_the_cross-lingual_transfer_of_composi.md)
- [\[ACL 2025\] Why Safeguarded Ships Run Aground? Aligned Large Language Models' Safety Mechanisms Tend to Be Anchored in The Template Region](../../ACL2025/object_detection/why_safeguarded_ships_run_aground_aligned_large_language_models_safety_mechanism.md)
