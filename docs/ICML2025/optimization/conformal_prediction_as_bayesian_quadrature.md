...
description: >-
  [ICML 2025 Oral][优化/理论][共形预测] 从贝叶斯视角重新审视共形预测——证明分裂共形预测和共形风险控制都是贝叶斯求积（Bayesian Quadrature）框架的特例，提出实用的贝叶斯替代方案，提供可解释的保证和对未来损失范围的更丰富表示。 领域现状：分布无关的不确定性量化（如共形预测）为黑盒模型的部署…
tags:
  - "ICML 2025 Oral"
  - "优化/理论"
  - "共形预测"
