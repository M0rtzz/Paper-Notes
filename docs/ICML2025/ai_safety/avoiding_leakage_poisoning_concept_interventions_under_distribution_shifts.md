...
description: >-
  [ICML 2025][AI安全][概念瓶颈模型] 揭示概念模型（CBM）中的"泄漏中毒"现象——绕过概念瓶颈的信息泄漏在分布偏移下反而损害预测准确率，使概念干预失效，提出 MixCEM 通过置信度门控动态决定何时使用/丢弃泄漏信息，在分布内外均保持高准确率和有效干预。 领域现状：概念瓶颈模型（CBM）先预测人类可理解的概念…
tags:
  - "ICML 2025"
  - "AI安全"
  - "概念瓶颈模型"
