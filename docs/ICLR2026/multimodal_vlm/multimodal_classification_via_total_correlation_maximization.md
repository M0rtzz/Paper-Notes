...
- [COAP: Memory-Efficient Training with Correlation-Aware Gradient Projection](../../CVPR2025/multimodal_vlm/coap_memory-efficient_training_with_correlation-aware_gradient_projection.md)
