...
description: >-
  [计算生物] 将氨基酸序列视为 LLM 的"第二语言"，通过构建蛋白质-自然语言双语数据集和自适应上下文构造机制，无需任何训练即可让通用 LLM 在蛋白质问答任务上平均提升 7% ROUGE-L，最高 17.2%，甚至超越领域专用微调模型。 领域现状： 蛋白质功能理解主要有两大范式：(1) 蛋白质表示学习——在氨基酸序列上自…
tags:
  - "计算生物"
---
