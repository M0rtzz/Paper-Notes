...
description: >-
  [ICLR 2026][物理/科学计算][政策短视] 论证政策短视（policy myopia）不是注意力分配问题，而是一个制度性机制——通过显著性捕获、能力级联和价值锁死三个耦合的正反馈循环，在后AGI时代系统性地、不可逆地剥夺人类的治理参与能力，而标准的缓解措施只能延缓但无法阻止这一过程。
tags:
  - "ICLR 2026"
  - "物理/科学计算"
  - "政策短视"
...
### 整体框架
本文不训练模型，而是把"政策短视"拆成三个互相喂料的正反馈机制——显著性捕获、能力级联、价值锁死——各自写成一组动力学方程，再放进同一套耦合系统里做数值模拟，观察经济、政治、文化三个子系统如何同步退化。框架的论证落点不是"短视有多严重"，而是要说明这三个机制一旦咬合，人类失权就成了制度的理性均衡，而非可以靠打补丁修掉的偏差。
