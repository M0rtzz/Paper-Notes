...
description: >-
  [ICLR 2026][LLM推理][数学推理] 借鉴代码补全中的 Fill-in-the-Middle (FIM) 范式，训练一个专门的步骤扩展模型 MathFimer-7B，在已有数学解题链中插入更细粒度的中间推理步骤，从而系统性提升下游模型的数学推理能力。 Chain-of-Thought (CoT) 已是 LLM 数…
tags:
  - "ICLR 2026"
  - "LLM推理"
  - "数学推理"
