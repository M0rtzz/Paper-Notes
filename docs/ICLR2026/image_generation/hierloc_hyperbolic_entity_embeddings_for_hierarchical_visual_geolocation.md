...
description: >-
  [ICLR 2026][图像生成][视觉地理定位] 提出HierLoc，将地理定位重新建模为双曲空间中的图像-实体对齐问题，用24万个地理实体嵌入替代500万+图像嵌入，在OSV5M上降低19.5%平均测地误差并将子区域准确率提升43%。 视觉地理定位（从图像内容推断拍摄地点）是一个跨尺度的全球挑战。现有方法分为检索式（需索…
tags:
  - "ICLR 2026"
  - "图像生成"
  - "视觉地理定位"
