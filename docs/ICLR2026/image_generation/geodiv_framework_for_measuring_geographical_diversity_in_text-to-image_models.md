...
### 评估策略
- VQA/VLM 主用 Gemini-2.5-flash（最优精度 86%，与人工的相关系数 ρ=0.76/0.69）
- 评估覆盖 4 个 T2I 模型、10 个实体、16 个国家，共 160,000 张合成图像
