...
description: >-
  [NeurIPS 2025][多模态VLM][场景理解] 提出E3VQA基准和M3CoT提示技术，通过融合第一人称和第三人称视角的场景图，增强LVLM的多视角推理能力，GPT-4o提升4.84%。
tags:
  - NeurIPS 2025
  - 多模态
  - 视觉语言模型
...
1. **视野窄**：头戴相机的 FOV 有限，无法看到全局场景
2. **缺乏全局上下文**：只能看到用户正在关注的局部区域
3. **空间推理困难**：难以回答需要全局空间信息的问题
