...
description: >-
  [NeurIPS 2025][多模态VLM][多模态数据集] 发布首个同步多模态野生动物监测数据集SmartWilds，整合无人机影像、相机陷阱和生物声学三种模态共101GB数据，通过GPS/时间戳实现跨模态对齐，建立可重复的保护监测标准协议，填补综合性生态系统多传感器融合数据集的空白。 领域现状：保护生物学正迎来多传感器+…
tags:
  - "NeurIPS 2025"
  - "多模态VLM"
  - "多模态数据集"
