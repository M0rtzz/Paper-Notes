...
description: >-
  [NeurIPS 2025][人体理解][低资源翻译] 提出 Reflective Translation 框架，让 LLM 在推理时对自身的初始翻译进行结构化自我批判（识别误译/遗漏/语义扭曲），再根据批判生成修正翻译，无需微调或额外标注数据即可在 isiZulu/isiXhosa 等低资源非洲语言上取得 BLEU 和 COMET 的统计显著提升。
tags:
  - NeurIPS 2025
  - 人体理解
  - 低资源翻译
