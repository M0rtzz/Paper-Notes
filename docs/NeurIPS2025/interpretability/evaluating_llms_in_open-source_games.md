...
description: >-
  [NeurIPS 2025][可解释性][博弈论] 通过开源游戏（智能体提交程序而非原始行动）这一新范式，系统评估 LLM 在战略推理、互相学习和合作博弈中的能力，发现 LLM 可自动发现近似程序平衡。 领域现状：LLM 多智能体研究多关注通讯、任务分解，很少触及战略推理和合作问题；传统博弈论主要针对人或传统 RL 智能体…
tags:
  - "NeurIPS 2025"
  - "可解释性"
  - "博弈论"
