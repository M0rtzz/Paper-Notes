...
description: >-
  [NeurIPS 2025][可解释性][dataset distillation] 提出 Linear Gradient Matching 方法，为预训练自监督视觉模型蒸馏合成数据集：每类仅需一张合成图就能训练出接近全数据集表现的线性分类器，且蒸馏图像可跨模型架构迁移。 领域现状：数据集蒸馏旨在合成极少量图像…
tags:
  - "NeurIPS 2025"
  - "可解释性"
