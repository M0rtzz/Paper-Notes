...
description: >-
  [NeurIPS 2025][预训练][决策变量相关] 本文提出基于决策变量相关（DVC）的新方法来衡量两个神经表征在分类任务上的逐试次一致性，发现深度网络在 ImageNet 上准确率越高反而与猴脑 V4/IT 的 DVC 越低，对抗训练和大规模数据集预训练也无法缩小这一差距。 如何比较深度网络与大脑的表征是计算神经科学的…
tags:
  - "NeurIPS 2025"
  - "预训练"
  - "决策变量相关"
