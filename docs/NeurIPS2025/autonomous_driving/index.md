---
title: >-
  NeurIPS2025 自动驾驶论文汇总 · 47篇论文解读
description: >-
  47篇NeurIPS2025的自动驾驶方向论文解读，涵盖自动驾驶、Agent、时序预测、遥感、多模态、自监督学习等方向。覆盖该方向前沿研究进展与技术创新，每篇含一句话总结、核心思想、方法详解、实验结果与局限性分析，5分钟读懂一篇论文核心思想。
tags:
  - "NeurIPS2025"
  - "自动驾驶"
  - "论文解读"
...
🔥 **高频主题：** 自动驾驶 ×8 · Agent ×5 · 时序预测 ×3 · 遥感 ×3 · 多模态 ×3
