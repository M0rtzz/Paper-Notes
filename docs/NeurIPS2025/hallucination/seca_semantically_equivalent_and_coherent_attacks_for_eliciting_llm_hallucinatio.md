...
description: >-
  [NeurIPS 2025][幻觉检测][LLM hallucination] 提出 SECA（Semantically Equivalent and Coherent Attacks），通过保持语义等价和语义连贯性的现实主义提示修改来诱发 LLM 幻觉，在多选 QA 任务上实现更高攻击成功率且几乎无语义错误。
tags:
  - "NeurIPS 2025"
  - "幻觉检测"
  - "LLM hallucination"
