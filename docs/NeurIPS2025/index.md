...
**[ARGenSeg: Image Segmentation with Autoregressive Image Generation Model](image_generation/argenseg_image_segmentation_with_autoregressive_image_generation_model.md)**
...
**[Diffusion Model as a Noise-Aware Latent Reward Model for Step-Level Preference Optimization](image_generation/diffusion_model_as_a_noiseaware_latent_reward_model_for_step.md)**
...
**[FineGRAIN: Evaluating Failure Modes of Text-to-Image Models with Vision Language Model Judges](image_generation/finegrain_evaluating_failure_modes_of_text-to-image_models_with_vision_language_.md)**
...
**[InstanceAssemble: Layout-Aware Image Generation via Instance Assembling Attention](image_generation/instanceassemble_layoutaware_image_generation_via_instance_a.md)**
...
**[More Than Generation: Unifying Generation and Depth Estimation via Text-to-Image Diffusion Models](image_generation/more_than_generation_unifying_generation_and_depth_estimation_via_text-to-image_.md)**

:   Merge提出了一种即插即用的框架，在固定的预训练T2I扩散模型前插入轻量级可学习的Converter，仅用约12%的额外参数就能赋予模型深度估计能力，同时完美保留原有的图像生成能力，在多个零样本深度估计基准上达到了统一模型的SOTA。

**[MultiHuman-Testbench: Benchmarking Image Generation for Multiple Humans](image_generation/multihuman-testbench_benchmarking_image_generation_for_multiple_humans.md)**
...
**[OverLayBench: A Benchmark for Layout-to-Image Generation with Dense Overlaps](image_generation/overlaybench_a_benchmark_for_layout-to-image_generation_with_dense_overlaps.md)**
...
**[RAG-IGBench: Innovative Evaluation for RAG-based Interleaved Generation in Open-domain Question Answering](image_generation/rag-igbench_innovative_evaluation_for_rag-based_interleaved_generation_in_open-d.md)**
...
**[Rethinking Direct Preference Optimization in Diffusion Models](image_generation/rethinking_direct_preference_optimization_in_diffusion_models.md)**
...
**[Seg4Diff: Unveiling Open-Vocabulary Segmentation in Text-to-Image Diffusion Transformers](image_generation/seg4diff_unveiling_open-vocabulary_segmentation_in_text-to-image_diffusion_trans.md)**
...
**[MMaDA: Multimodal Large Diffusion Language Models](reinforcement_learning/mmada_multimodal_large_diffusion_language_models.md)**
...
**[MRO: Enhancing Reasoning in Diffusion Language Models via Multi-Reward Optimization](reinforcement_learning/mro_enhancing_reasoning_in_diffusion_language_models_via_multi-reward_optimizati.md)**
...
**[Open-World Drone Active Tracking with Goal-Centered Rewards](reinforcement_learning/open-world_drone_active_tracking_with_goal-centered_rewards.md)**
...
**[Reinforcing the Diffusion Chain of Lateral Thought with Diffusion Language Models](reinforcement_learning/reinforcing_the_diffusion_chain_of_lateral_thought_with_diffusion_language_model.md)**
...
**[ReSearch: Learning to Reason with Search for LLMs via Reinforcement Learning](reinforcement_learning/research_learning_to_reason_with_search_for_llms_via_reinforcement_learning.md)**
...
**[DenoiseRotator: Enhance Pruning Robustness for LLMs via Importance Concentration](model_compression/denoiserotator_enhance_pruning_robustness_for_llms_via_importance_concentration.md)**
...
**[Explaining and Mitigating Crosslingual Tokenizer Inequities](model_compression/explaining_and_mitigating_crosslingual_tokenizer_inequities.md)**
...
**[Few-Shot Knowledge Distillation of LLMs With Counterfactual Explanations](model_compression/few-shot_knowledge_distillation_of_llms_with_counterfactual_explanations.md)**
...
**[Fin3R: Fine-tuning Feed-forward 3D Reconstruction Models via Monocular Knowledge Distillation](model_compression/fin3r_fine-tuning_feed-forward_3d_reconstruction_models_via_monocular_knowledge_.md)**
...
**[How to Build a Consistency Model: Learning Flow Maps via Self-Distillation](model_compression/how_to_build_a_consistency_model_learning_flow_maps_via_self-distillation.md)**
...
**[Knowledge Distillation Detection for Open-weights Models](model_compression/knowledge_distillation_detection_for_open-weights_models.md)**
...
**[Mixed Monotonicity Reachability Analysis of Neural ODE: A Trade-Off Between Tightness and Efficiency](model_compression/mixed_monotonicity_reachability_analysis_of_neural_ode_a_trade-off_between_tight.md)**
...
**[MTL-KD: Multi-Task Learning Via Knowledge Distillation for Generalizable Neural Vehicle Routing Solver](model_compression/mtl-kd_multi-task_learning_via_knowledge_distillation_for_generalizable_neural_v.md)**
...
**[ORPO-Distill: Mixed-Policy Preference Optimization for Cross-Architecture LLM Distillation](model_compression/orpo-distill_mixed-policy_preference_optimization_for_cross-architecture_llm_dis.md)**
...
**[Perturbation Bounds for Low-Rank Inverse Approximations under Noise](model_compression/perturbation_bounds_for_low-rank_inverse_approximations_under_noise.md)**
...
**[PKD: Preference-driven Knowledge Distillation for Few-shot Node Classification](model_compression/preference-driven_knowledge_distillation_for_few-shot_node_classification.md)**
...
**[SCAN: Self-Denoising Monte Carlo Annotation for Robust Process Reward Learning](model_compression/scan_self-denoising_monte_carlo_annotation_for_robust_process_reward_learning.md)**
...
**[Weight Weaving: Parameter Pooling for Data-Free Model Merging](model_compression/weight_weaving_parameter_pooling_for_data-free_model_merging.md)**
...
**[Why Knowledge Distillation Works in Generative Models: A Minimal Working Explanation](model_compression/why_knowledge_distillation_works_in_generative_models_a_minimal_working_explanat.md)**

:   通过高斯混合模型的理论分析和大规模语言模型实验（SmolLM2 系列多级蒸馏），揭示知识蒸馏在生成模型中的核心机制——蒸馏诱导学生模型在精度（precision，生成质量）和召回（recall，分布覆盖度）之间进行权衡，由教师分布的熵控制。

**[Zero-Shot Embedding Drift Detection: A Lightweight Defense Against Prompt Injections in LLMs](model_compression/zero-shot_embedding_drift_detection_a_lightweight_defense_against_prompt_injecti.md)**
...
**[GUI-Rise: Structured Reasoning and History Summarization for GUI Navigation](multimodal_vlm/gui-rise_structured_reasoning_and_history_summarization_for_gui_navigation.md)**
...
**[MIP against Agent: Malicious Image Patches Hijacking Multimodal OS Agents](multimodal_vlm/mip_against_agent_malicious_image_patches_hijacking_multimod.md)**
...
**[mmWalk: Towards Multi-modal Multi-view Walking Assistance](multimodal_vlm/mmwalk_towards_multi-modal_multi-view_walking_assistance.md)**
...
**[Multimodal Disease Progression Modeling via Spatiotemporal Disentanglement and Multiscale Alignment](multimodal_vlm/multimodal_disease_progression_modeling_via_spatiotemporal_disentanglement_and_m.md)**
...
**[SmartWilds: Multimodal Wildlife Monitoring Dataset](multimodal_vlm/smartwilds_multimodal_wildlife_monitoring_dataset.md)**
...
**[VITRIX-CLIPIN: Enhancing Fine-Grained Visual Understanding in CLIP via Instruction Editing Data and Long Captions](multimodal_vlm/vitrix-clipin_enhancing_fine-grained_visual_understanding_in_clip_via_instructio.md)**
...
**[CHiQPM: Calibrated Hierarchical Interpretable Image Classification](optimization/chiqpm_calibrated_hierarchical_interpretable_image_classification.md)**
...
**[Conformal Prediction for Causal Effects of Continuous Treatments](optimization/conformal_prediction_for_causal_effects_of_continuous_treatments.md)**

:   首次为连续处理变量（如药物剂量）的因果效应构建共形预测区间，通过倾向性偏移参数化和分位数回归，在已知/未知倾向性两种场景下均提供有限样本 $1-\alpha$ 覆盖保证。

**[Conformal Prediction in The Loop: A Feedback-Based Uncertainty Model for Trajectory Optimization](optimization/conformal_prediction_in_the_loop_a_feedback-based_uncertainty_model_for_trajecto.md)**
...
**[DeltaProduct: Improving State-Tracking in Linear RNNs via Householder Products](optimization/deltaproduct_improving_state-tracking_in_linear_rnns_via_householder_products.md)**
...
**[Fantastic Features and Where to Find Them: A Probing Method to Combine Features from Multiple Foundation Models](optimization/fantastic_features_and_where_to_find_them_a_probing_method_to_combine_features_f.md)**
...
**[FLUX: Efficient Descriptor-Driven Clustered Federated Learning under Arbitrary Distribution Shifts](optimization/flux_efficient_descriptor-driven_clustered_federated_learning_under_arbitrary_di.md)**
...
**[FlyLoRA: Boosting Task Decoupling and Parameter Efficiency via Implicit Rank-Wise Mixture-of-Experts](optimization/flylora_boosting_task_decoupling_and_parameter_efficiency_via_implicit_rank-wise.md)**
...
**[MergeBench: A Benchmark for Merging Domain-Specialized LLMs](optimization/mergebench_a_benchmark_for_merging_domain-specialized_llms.md)**
...
**[One Sample is Enough to Make Conformal Prediction Robust](optimization/one_sample_is_enough_to_make_conformal_prediction_robust.md)**
...
**[Private Zeroth-Order Optimization with Public Data](optimization/private_zeroth-order_optimization_with_public_data.md)**
...
**[Robust LLM Alignment via Distributionally Robust Direct Preference Optimization](optimization/robust_llm_alignment_via_distributionally_robust_direct_preference_optimization.md)**
...
**[The Trilemma of Truth in Large Language Models](optimization/the_trilemma_of_truth_in_large_language_models.md)**

:   提出 sAwMIL（稀疏感知多实例学习）三类探测框架，结合 MIL 和保形预测，将 LLM 内部激活分类为 true/false/neither，揭示真假信号并非简单的双向对称编码，而是跨越多维子空间的分布式表征。

**[Towards Reliable and Holistic Visual In-Context Learning Prompt Selection](optimization/towards_reliable_and_holistic_visual_in-context_learning_prompt_selection.md)**
...
**[Train with Perturbation, Infer after Merging: A Two-Stage Framework for Continual Learning](optimization/train_with_perturbation_infer_after_merging_a_two-stage_framework_for_continual_.md)**
...
**[Uncertainty Quantification for Reduced-Order Surrogate Models Applied to Cloud Microphysics](optimization/uncertainty_quantification_for_reduced-order_surrogate_models_applied_to_cloud_m.md)**
...
**[Dynamics of Spontaneous Topic Changes in Next Token Prediction with Self-Attention](3d_vision/dynamics_of_spontaneous_topic_changes_in_next_token_prediction_with_self-attenti.md)**
...
**[Enhancing Multilingual LLM Pretraining with Model-Based Data Selection](3d_vision/enhancing_multilingual_llm_pretraining_with_model-based_data_selection.md)**
...
**[Fair Representation Learning with Controllable High Confidence Guarantees via Adversarial Inference](3d_vision/fair_representation_learning_with_controllable_high_confidence_guarantees_via_ad.md)**
...
**[FedFACT: A Provable Framework for Controllable Group-Fairness Calibration in Federated Learning](3d_vision/fedfact_a_provable_framework_for_controllable_group-fairness_calibration_in_fede.md)**
...
**[Learning Generalizable Shape Completion with SIM(3) Equivariance](3d_vision/learning_generalizable_shape_completion_with_sim3_equivariance.md)**
...
**[MVSMamba: Multi-View Stereo with State Space Model](3d_vision/mvsmamba_multi-view_stereo_with_state_space_model.md)**
...
**[Web-Scale Collection of Video Data for 4D Animal Reconstruction](3d_vision/web-scale_collection_of_video_data_for_4d_animal_reconstruction.md)**
...
**[You Can Trust Your Clustering Model: A Parameter-free Self-Boosting Plug-in for Deep Clustering](3d_vision/you_can_trust_your_clustering_model_a_parameter-free_self-boosting_plug-in_for_d.md)**
...
**[Attractive Metadata Attack: Inducing LLM Agents to Invoke Malicious Tools](llm_safety/attractive_metadata_attack_inducing_llm_agents_to_invoke_malicious_tools.md)**
...
**[Bias in the Picture: Benchmarking VLMs with Social-Cue News Images and LLM-as-Judge Assessment](llm_safety/bias_in_the_picture_benchmarking_vlms_with_social-cue_news_images_and_llm-as-jud.md)**
...
**[Distillation Robustifies Unlearning](llm_safety/distillation_robustifies_unlearning.md)**
...
**[DRAGON: Guard LLM Unlearning in Context via Negative Detection and Reasoning](llm_safety/dragon_guard_llm_unlearning_in_context_via_negative_detection_and_reasoning.md)**

:   DRAGON 提出无需微调基座模型的系统性 LLM 遗忘框架：通过双层检测模块识别需遗忘的 prompt，再由专门微调的 guard 模型生成 CoT 推理指令实现上下文干预，在保持模型通用能力的同时有效删除隐私/有害知识。

**[DRIFT: Dynamic Rule-Based Defense with Injection Isolation for Securing LLM Agents](llm_safety/drift_dynamic_rulebased_defense_with_injection_isolation_for.md)**
...
**[Evaluation of Vision-LLMs in Surveillance Video](llm_safety/evaluation_of_vision-llms_in_surveillance_video.md)**
...
**[FALCON: Fine-grained Activation Manipulation by Contrastive Orthogonal Unalignment for Large Language Model](llm_safety/falcon_fine-grained_activation_manipulation_by_contrastive_orthogonal_unalignmen.md)**
...
**[HoloLLM: Multisensory Foundation Model for Language-Grounded Human Sensing and Reasoning](llm_safety/holollm_multisensory_foundation_model_for_language-grounded_human_sensing_and_re.md)**
...
**[ImageSentinel: Protecting Visual Datasets from Unauthorized Retrieval-Augmented Image Generation](llm_safety/imagesentinel_protecting_visual_datasets_from_unauthorized_retrieval-augmented_i.md)**
...
**[ModHiFi: Identifying High Fidelity Predictive Components for Model Modification](llm_safety/modhifi_identifying_high_fidelity_predictive_components_for_model_modification.md)**
...
**[On Optimal Steering to Achieve Exact Fairness](llm_safety/on_optimal_steering_to_achieve_exact_fairness.md)**
...
**[One Token Embedding Is Enough to Deadlock Your Large Reasoning Model](llm_safety/one_token_embedding_is_enough_to_deadlock_your_large_reasoning_model.md)**
...
**[PatientSim: A Persona-Driven Simulator for Realistic Doctor-Patient Interactions](llm_safety/patientsim_a_persona-driven_simulator_for_realistic_doctor-patient_interactions.md)**
...
**[Position: The Complexity of Perfect AI Alignment -- Formalizing the RLHF Trilemma](llm_safety/position_the_complexity_of_perfect_ai_alignment_--_formalizing_the_rlhf_trilemma.md)**
...
**[Robust or Suggestible? Exploring Non-Clinical Induction in LLM Drug-Safety Decisions](llm_safety/robust_or_suggestible_exploring_non-clinical_induction_in_llm_drug-safety_decisi.md)**
...
**[Securing the Language of Life: Inheritable Watermarks from DNA Language Models to Proteins](llm_safety/securing_the_language_of_life_inheritable_watermarks_from_dna_language_models_to.md)**
...
**[Simplicity Prevails: Rethinking Negative Preference Optimization for LLM Unlearning](llm_safety/simplicity_prevails_rethinking_negative_preference_optimization_for_llm_unlearni.md)**
...
**[Steering When Necessary: Flexible Steering Large Language Models with Backtracking](llm_safety/steering_when_necessary_flexible_steering_large_language_models_with_backtrackin.md)**
...
**[Unlearned but Not Forgotten: Data Extraction after Exact Unlearning in LLM](llm_safety/unlearned_but_not_forgotten_data_extraction_after_exact_unlearning_in_llm.md)**
...
**[VMDT: Decoding the Trustworthiness of Video Foundation Models](llm_safety/vmdt_decoding_the_trustworthiness_of_video_foundation_models.md)**
...
**[Watermarking Autoregressive Image Generation](llm_safety/watermarking_autoregressive_image_generation.md)**
...
**[Zero-Shot Robustness of Vision Language Models Via Confidence-Aware Weighting](llm_safety/zero-shot_robustness_of_vision_language_models_via_confidence-aware_weighting.md)**
...
**[ChartMuseum: Testing Visual Reasoning Capabilities of Large Vision-Language Models](llm_reasoning/chartmuseum_testing_visual_reasoning_capabilities_of_large_v.md)**
...
**[First SFT, Second RL, Third UPT: Continual Improving Multi-Modal LLM Reasoning via Unsupervised Post-Training](llm_reasoning/first_sft_second_rl_third_upt_continual_improving_multi-modal_llm_reasoning_via_.md)**

:   提出 MM-UPT 框架，在 SFT 和 RL 之后引入第三阶段"无监督后训练"，通过多数投票作为伪奖励信号结合 GRPO 实现 MLLM 的自我改进，在 MathVista 上将 Qwen2.5-VL-7B 从 66.3% 提升至 72.9%。

**[FractalBench: Diagnosing Visual-Mathematical Reasoning Through Recursive Program Synthesis](llm_reasoning/fractalbench_diagnosing_visual-mathematical_reasoning_through_recursive_program_.md)**
...
**[KTAE: A Model-Free Algorithm to Key-Tokens Advantage Estimation in Mathematical Reasoning](llm_reasoning/ktae_a_model-free_algorithm_to_key-tokens_advantage_estimation_in_mathematical_r.md)**
...
**[Martingale Score: An Unsupervised Metric for Bayesian Rationality in LLM Reasoning](llm_reasoning/martingale_score_an_unsupervised_metric_for_bayesian_rationality_in_llm_reasonin.md)**
...
**[MuSLR: Multimodal Symbolic Logical Reasoning](llm_reasoning/muslr_multimodal_symbolic_logical_reasoning.md)**
...
**[PolyMath: Evaluating Mathematical Reasoning in Multilingual Contexts](llm_reasoning/polymath_evaluating_mathematical_reasoning_in_multilingual_contexts.md)**
...
**[SAND-Math: Using LLMs to Generate Novel, Difficult and Useful Mathematics Questions and Answers](llm_reasoning/sand-math_using_llms_to_generate_novel_difficult_and_useful_mathematics_question.md)**
...
**[Self-Evaluating LLMs for Multi-Step Tasks: Stepwise Confidence Estimation for Failure Detection](llm_reasoning/self-evaluating_llms_for_multi-step_tasks_stepwise_confidence_estimation_for_fai.md)**
...
**[SRPO: Enhancing Multimodal LLM Reasoning via Reflection-Aware Reinforcement Learning](llm_reasoning/srpo_enhancing_multimodal_llm_reasoning_via_reflection-aware_reinforcement_learn.md)**
...
**[SWE-RL: Advancing LLM Reasoning via Reinforcement Learning on Open Software Evolution](llm_reasoning/swe-rl_advancing_llm_reasoning_via_reinforcement_learning_on_open_software_evolu.md)**
...
**[The Ouroboros of Benchmarking: Reasoning Evaluation in an Era of Saturation](llm_reasoning/the_ouroboros_of_benchmarking_reasoning_evaluation_in_an_era_of_saturation.md)**
...
**[Trajectory Bellman Residual Minimization: A Simple Value-Based Method for LLM Reasoning](llm_reasoning/trajectory_bellman_residual_minimization_a_simple_value-based_method_for_llm_rea.md)**
...
**[VideoRFT: Incentivizing Video Reasoning Capability in MLLMs via Reinforced Fine-Tuning](llm_reasoning/videorft_incentivizing_video_reasoning_capability_in_mllms_via_reinforced_fine-t.md)**
...
**[WebThinker: Empowering Large Reasoning Models with Deep Research Capability](llm_reasoning/webthinker_empowering_large_reasoning_models_with_deep_research_capability.md)**
...
**[Benchmarking Probabilistic Time Series Forecasting Models on Neural Activity](interpretability/benchmarking_probabilistic_time_series_forecasting_models_on_neural_activity.md)**
...
**[Dense SAE Latents Are Features, Not Bugs](interpretability/dense_sae_latents_are_features_not_bugs.md)**
...
**[LLM World Models Are Mental: Output Layer Evidence of Brittle World Model Use in LLM Mechanical Reasoning](interpretability/llm_world_models_are_mental_output_layer_evidence_of_brittle_world_model_use_in_.md)**
...
**[Reasoning by Superposition: A Theoretical Perspective on Chain of Continuous Thought](interpretability/reasoning_by_superposition_a_theoretical_perspective_on_chain_of_continuous_thou.md)**
...
**[Representation Consistency for Accurate and Coherent LLM Answer Aggregation](interpretability/representation_consistency_for_accurate_and_coherent_llm_answer_aggregation.md)**
...
**[Specialization after Generalization: Towards Understanding Test-Time Training in Foundation Models](interpretability/specialization_after_generalization_towards_understanding_test-time_training_in_.md)**
...
**[Superposition Yields Robust Neural Scaling](interpretability/superposition_yields_robust_neural_scaling.md)**
...
**[Understanding Prompt Tuning and In-Context Learning via Meta-Learning](interpretability/understanding_prompt_tuning_and_in-context_learning_via_meta-learning.md)**
...
**[Beyond Chemical QA: Evaluating LLM's Chemical Reasoning with Modular Chemical Operations](computational_biology/beyond_chemical_qa_evaluating_llms_chemical_reasoning_with_modular_chemical_oper.md)**
...
**[Constrained Discrete Diffusion](computational_biology/constrained_discrete_diffusion.md)**

:   提出 CDD（Constrained Discrete Diffusion），将可微约束优化投影算子嵌入离散扩散模型的去噪过程中，无需重训练即可在采样时强制满足序列级约束，在毒性文本生成、分子设计和指令遵循三类任务上实现零约束违反。

**[Curly Flow Matching for Learning Non-gradient Field Dynamics](computational_biology/curly_flow_matching_for_learning_non-gradient_field_dynamics.md)**
...
**[De novo generation of functional terpene synthases using TpsGPT](computational_biology/de_novo_generation_of_functional_terpene_synthases_using_tpsgpt.md)**
...
**[DesignX: Human-Competitive Algorithm Designer for Black-Box Optimization](computational_biology/designx_human-competitive_algorithm_designer_for_black-box_optimization.md)**
...
**[Diffusion Generative Modeling on Lie Group Representations](computational_biology/diffusion_generative_modeling_on_lie_group_representations.md)**

:   提出在李群**表示空间**（而非李群本身）上构建扩散过程的新理论框架，通过广义分数匹配将非阿贝尔李群的弯曲动力学映射到欧几里得空间中，实现无模拟训练的李群扩散模型，并证明标准分数匹配是其平移群的特例。

**[EDBench: Large-Scale Electron Density Data for Molecular Modeling](computational_biology/edbench_large-scale_electron_density_data_for_molecular_modeling.md)**

:   构建了目前最大规模的电子密度（ED）数据集 EDBench（330 万分子，基于 B3LYP/6-31G** DFT 计算），并设计了涵盖预测、检索、生成三类任务的 ED 基准评估体系，首次系统评估了深度学习模型对电子密度的理解和利用能力。

**[Energy Loss Functions for Physical Systems](computational_biology/energy_loss_functions_for_physical_systems.md)**

:   提出基于物理能量的损失函数框架，通过反向 KL 散度与玻尔兹曼分布推导出以成对距离为基础的能量差损失，天然满足 SE(d) 不变性，在分子生成和自旋基态预测中显著优于 MSE 和交叉熵损失。

**[Energy Matching: Unifying Flow Matching and Energy-Based Models for Generative Modeling](computational_biology/energy_matching_unifying_flow_matching_and_energy-based_models_for_generative_mo.md)**
...
**[Evaluating Multiple Models Using Labeled and Unlabeled Data](computational_biology/evaluating_multiple_models_using_labeled_and_unlabeled_data.md)**
...
**[FGBench: A Dataset and Benchmark for Molecular Property Reasoning at Functional Group-Level in Large Language Models](computational_biology/fgbench_a_dataset_and_benchmark_for_molecular_property_reasoning_at_functional_g.md)**
...
**[Flow Density Control: Generative Optimization Beyond Entropy-Regularized Fine-Tuning](computational_biology/flow_density_control_generative_optimization_beyond_entropy-regularized_fine-tun.md)**

:   提出 Flow Density Control（FDC），将预训练流/扩散模型的微调从 KL 正则期望奖励最大化推广到**任意分布效用函数 + 任意散度正则**的通用框架，通过将非线性目标分解为一系列线性微调子任务实现，并提供收敛保证。

**[Fractional Diffusion Bridge Models](computational_biology/fractional_diffusion_bridge_models.md)**

:   提出分数扩散桥模型（FDBM），将分数布朗运动（fBM）引入生成扩散桥框架，通过 Hurst 指数 $H$ 控制轨迹的粗糙度和长程依赖性，在蛋白质构象预测和图像翻译任务上超越布朗运动基线。

**[g-DPO: Scalable Preference Optimization for Protein Language Models](computational_biology/g-dpo_scalable_preference_optimization_for_protein_language_models.md)**
...
**[Generalizable Insights for Graph Transformers in Theory and Practice](computational_biology/generalizable_insights_for_graph_transformers_in_theory_and_practice.md)**
...
**[Generative Distribution Embeddings: Lifting Autoencoders to the Space of Distributions for Multiscale Representation Learning](computational_biology/generative_distribution_embeddings_lifting_autoencoders_to_the_space_of_distribu.md)**

:   提出生成分布嵌入（GDE），将自编码器提升到分布空间——编码器作用于样本集合，解码器替换为条件生成模型，学习分布级别的表示，并在6个计算生物学任务上验证有效性。

**[Generative Modeling of Full-Atom Protein Conformations using Latent Diffusion on Graph Embeddings](computational_biology/generative_modeling_of_full-atom_protein_conformations_using_latent_diffusion_on.md)**

:   提出 **LD-FPG** 框架，使用 Chebyshev 图神经网络将蛋白质全原子 MD 轨迹编码到低维潜在空间，再用 DDPM 在该空间中生成新的构象集合体（ensemble），首次实现了包含侧链所有重原子的蛋白质构象生成。

**[Graph Diffusion that can Insert and Delete](computational_biology/graph_diffusion_that_can_insert_and_delete.md)**

:   提出 GrIDDD 模型，首次将离散去噪扩散模型（DDPM）扩展为支持在生成过程中**动态插入和删除图节点**，使分子图的大小可在扩散过程中自适应变化，在性质靶向和分子优化任务上达到或超过现有方法。

**[Inferring Stochastic Dynamics with Growth from Cross-Sectional Data](computational_biology/inferring_stochastic_dynamics_with_growth_from_cross-sectional_data.md)**

:   提出非平衡概率流推断（UPFI），通过Fokker-Planck方程的Lagrangian形式化，从横截面数据中联合推断随机动力学系统的漂移项、扩散项和增长率，首次准确处理含细胞增殖/死亡的场景。

**[Interpreting GFlowNets for Drug Discovery: Extracting Actionable Insights for Medicinal Chemistry](computational_biology/interpreting_gflownets_for_drug_discovery_extracting_actionable_insights_for_med.md)**

:   为 SynFlowNet（基于合成反应模板的 GFlowNet）构建了一套多层次可解释性工具包，整合梯度显著性、反事实扰动、稀疏自编码器（SAE）和基序探针，揭示模型内部表征如何编码药物化学相关的理化性质和官能团信息。

**[Is Sequence Information All You Need for Bayesian Optimization of Antibodies?](computational_biology/is_sequence_information_all_you_need_for_bayesian_optimization_of_antibodies.md)**

:   本文系统比较了序列信息和结构信息在抗体贝叶斯优化中的作用，发现通过蛋白质语言模型（pLM）软约束，纯序列方法可以匹配结构方法的性能，质疑了结构信息在抗体贝叶斯优化中的必要性。

**[Iterative Foundation Model Fine-Tuning on Multiple Rewards](computational_biology/iterative_foundation_model_fine-tuning_on_multiple_rewards.md)**
...
**[JAMUN: Bridging Smoothed Molecular Dynamics and Score-Based Learning for Conformational Ensembles](computational_biology/jamun_bridging_smoothed_molecular_dynamics_and_score-based_learning_for_conforma.md)**
...
**[JanusDNA: A Powerful Bi-directional Hybrid DNA Foundation Model](computational_biology/janusdna_a_powerful_bi-directional_hybrid_dna_foundation_model.md)**

:   提出JanusDNA，首个双向DNA基础模型，结合Mamba-Attention-MoE混合架构和Janus Modeling训练范式，以自回归的训练效率实现双向理解，在多个基因组基准上达到SOTA。

**[KLASS: KL-Guided Fast Inference in Masked Diffusion Models](computational_biology/klass_kl-guided_fast_inference_in_masked_diffusion_models.md)**
...
**[Learning Conformational Ensembles of Proteins Based on Backbone Geometry](computational_biology/learning_conformational_ensembles_of_proteins_based_on_backbone_geometry.md)**

:   提出 BBFlow，一种基于蛋白质骨架几何信息的流匹配生成模型，用于蛋白质构象集合采样，无需进化序列信息或预训练折叠模型，推理速度比 AlphaFlow 快一个数量级以上，且可扩展到多链蛋白质。

**[Learning Relative Gene Expression Trends from Pathology Images in Spatial Transcriptomics](computational_biology/learning_relative_gene_expression_trends_from_pathology_images_in_spatial_transc.md)**

:   提出 STRank 损失函数，将病理图像基因表达估计重新定义为排序分数估计任务，利用二项分布/多项分布建模表达计数的随机噪声特性，使模型能从包含批次效应和随机波动的空间转录组数据中学习到鲁棒的相对表达关系。

**[Learning Repetition-Invariant Representations for Polymer Informatics](computational_biology/learning_repetition-invariant_representations_for_polymer_informatics.md)**

:   提出 GRIN（Graph Repetition-Invariant Network），通过 Max 聚合和特殊的图构建策略使 GNN 对聚合物重复单元的拼接数量不变，解决了聚合物表示中的基本对称性问题。

**[Manipulating 3D Molecules in a Fixed-Dimensional E(3)-Equivariant Latent Space](computational_biology/manipulating_3d_molecules_in_a_fixed-dimensional_e3-equivariant_latent_space.md)**
...
**[MEIcoder: Decoding Visual Stimuli from Neural Activity by Leveraging Most Exciting Inputs](computational_biology/meicoder_decoding_visual_stimuli_from_neural_activity_by_leveraging_most_excitin.md)**

:   提出 MEIcoder，利用神经元特异性的最激励输入(MEI)作为生物学先验、SSIM 损失和对抗训练，从初级视觉皮层(V1)的神经群体活动中实现 SOTA 级别的视觉刺激重建，尤其在小数据集和少量神经元场景下表现突出。

**[Modeling Microenvironment Trajectories on Spatial Transcriptomics with NicheFlow](computational_biology/modeling_microenvironment_trajectories_on_spatial_transcriptomics_with_nicheflow.md)**
...
**[Mol-LLaMA: Towards General Understanding of Molecules in Large Molecular Language Models](computational_biology/mol-llama_towards_general_understanding_of_molecules_in_large_molecular_language.md)**

:   提出 Mol-LLaMA，一个面向分子通用理解的大型分子语言模型，通过设计三类关键指令数据类型和 2D-3D 分子表示融合模块，在分子特征理解上超越 GPT-4o，具备可解释性和推理能力。

**[Multimodal 3D Genome Pre-training](computational_biology/multimodal_3d_genome_pre-training.md)**

:   提出MIX-HIC——首个面向3D基因组的多模态基础模型，通过跨模态交互块和跨模态映射块融合Hi-C接触图和表观基因组信号，在超过127万对样本上预训练，在Hi-C预测、染色质环检测和CAGE-seq表达预测三个下游任务上全面超越SOTA。

**[Multiscale Guidance of Protein Structure Prediction with Heterogeneous Cryo-EM Data](computational_biology/multiscale_guidance_of_protein_structure_prediction_with_heterogeneous_cryo-em_d.md)**

:   CryoBoltz利用冷冻电镜（cryo-EM）密度图通过多尺度引导机制（全局→局部）引导预训练扩散结构预测模型（Boltz-1）的采样轨迹，无需重新训练即可生成与实验数据一致的多构象原子模型。

**[Omni-Mol: Multitask Molecular Model for Any-to-Any Modalities](computational_biology/omni-mol_multitask_molecular_model_for_any-to-any_modalities.md)**
...
**[One Small Step with Fingerprints, One Giant Leap for De Novo Molecule Generation from Mass Spectra](computational_biology/one_small_step_with_fingerprints_one_giant_leap_for_de_novo_molecule_generation_.md)**

:   通过将 MIST 作为质谱-指纹编码器、MolForge 作为指纹-结构解码器，并采用先验调整阈值策略，在 MassSpecGym 基准上实现了从质谱从头生成分子结构的十倍性能提升（top-1 准确率从 2.3% 提升至 31%）。

**[Pharmacophore-Guided Generative Design of Novel Drug-Like Molecules](computational_biology/pharmacophore-guided_generative_design_of_novel_drug-like_molecules.md)**

:   提出一种药效团引导的分子生成框架，在强化学习模型（FREED++）的奖励函数中同时最大化药效团相似度和最小化结构相似度，生成既保留生物活性特征又具有高结构新颖性的候选药物分子。

**[Post Hoc Regression Refinement via Pairwise Rankings](computational_biology/post_hoc_regression_refinement_via_pairwise_rankings.md)**
...
**[PRESCRIBE: Predicting Single-Cell Responses with Bayesian Estimation](computational_biology/prescribe_predicting_single-cell_responses_with_bayesian_estimation.md)**
...
**[Prior-Guided Flow Matching for Target-Aware Molecule Design with Learnable Atom Number](computational_biology/prior-guided_flow_matching_for_target-aware_molecule_design_with_learnable_atom_.md)**

:   提出 PAFlow，基于流匹配框架的 3D 分子生成模型，通过蛋白-配体交互预测器引导向量场和可学习原子数预测器，在 CrossDocked2020 上实现 -8.31 Avg. Vina Score 的新 SOTA，大幅超越已有方法。

**[PROSPERO: Active Learning for Robust Protein Design Beyond Wild-Type Neighborhood](computational_biology/prospero_active_learning_for_robust_protein_design_beyond_wild-type_neighborhood.md)**

:   提出 ProSpero，一个主动学习框架，通过冻结的预训练生成模型（EvoDiff）在代理模型引导下的推理时采样、针对性掩码策略和生物约束的 SMC 采样，在代理模型可能失配的条件下仍能发现高适应性且新颖的蛋白质序列。

**[Protein Design with Dynamic Protein Vocabulary](computational_biology/protein_design_with_dynamic_protein_vocabulary.md)**
...
**[Quantifying the Role of OpenFold Components in Protein Structure Prediction](computational_biology/quantifying_the_role_of_openfold_components_in_protein_structure_prediction.md)**

:   本文提出系统方法评估 OpenFold/AlphaFold2 中 Evoformer 各组件对蛋白质结构预测精度的贡献，发现 MSA 列注意力和 MLP Transition 层是最关键的组件，且多个组件的重要性与蛋白质序列长度显著相关。

**[Random Search Neural Networks for Efficient and Expressive Graph Learning](computational_biology/random_search_neural_networks_for_efficient_and_expressive_graph_learning.md)**

:   提出随机搜索神经网络（RSNN），用随机深度优先搜索（DFS）替代随机游走来采样图结构，在稀疏图上仅需$O(\log|V|)$次搜索即可实现完整边覆盖，配合通用序列模型可达到通用逼近能力，在分子和蛋白质基准上以最多16倍更少的采样量持续超越RWNN。

**[Remasking Discrete Diffusion Models with Inference-Time Scaling](computational_biology/remasking_discrete_diffusion_models_with_inference-time_scaling.md)**

:   提出 ReMDM 采样器，通过在生成过程中允许已解码 token 被重新掩码（remask），赋予离散掩码扩散模型迭代纠错能力，实现推理时计算缩放，在文本、图像和分子设计任务上显著提升采样质量。

**[Retrosynthesis Planning via Worst-path Policy Optimisation in Tree-structured MDPs](computational_biology/retrosynthesis_planning_via_worst-path_policy_optimisation_in_tree-structured_md.md)**
...
**[scMRDR: A Scalable and Flexible Framework for Unpaired Single-Cell Multi-Omics Data Integration](computational_biology/scmrdr_a_scalable_and_flexible_framework_for_unpaired_single-cell_multi-omics_da.md)**

:   提出scMRDR框架，基于β-VAE将单细胞多组学数据的潜在表征解耦为模态共享和模态特异成分，通过等距正则化、对抗训练和掩码重建损失实现非配对多组学数据的可扩展整合。

**[scPilot: Large Language Model Reasoning Toward Automated Single-Cell Analysis and Discovery](computational_biology/scpilot_large_language_model_reasoning_toward_automated_single-cell_analysis_and.md)**
...
**[Self Iterative Label Refinement via Robust Unlabeled Learning](computational_biology/self_iterative_label_refinement_via_robust_unlabeled_learning.md)**

:   提出一种迭代式管道方法，利用鲁棒的无标签-无标签（UU）学习框架来精炼LLM生成的伪标签，仅需极少人工标注即可在分类和生成式安全对齐任务中超越GPT-4o和DeepSeek-R1的自我精炼方法。

**[SpecMER: Fast Protein Generation with K-mer Guided Speculative Decoding](computational_biology/specmer_fast_protein_generation_with_k-mer_guided_speculative_decoding.md)**
...
**[Split Gibbs Discrete Diffusion Posterior Sampling](computational_biology/split_gibbs_discrete_diffusion_posterior_sampling.md)**
...
**[Steering Generative Models with Experimental Data for Protein Fitness Optimization](computational_biology/steering_generative_models_with_experimental_data_for_protein_fitness_optimizati.md)**
...
**[Towards Multiscale Graph-based Protein Learning with Geometric Secondary Structural Motifs](computational_biology/towards_multiscale_graph-based_protein_learning_with_geometric_secondary_structu.md)**
...
**[Towards Unified and Lossless Latent Space for 3D Molecular Latent Diffusion Modeling](computational_biology/towards_unified_and_lossless_latent_space_for_3d_molecular_latent_diffusion_mode.md)**

:   提出 UAE-3D，一种多模态变分自编码器，将3D分子的原子类型、化学键和3D坐标压缩到统一的近无损潜在空间中，消除了处理多模态和等变性的复杂性，使通用 Diffusion Transformer 即可实现 SOTA 的3D分子生成。

**[Uncertainty-Aware Multi-Objective Reinforcement Learning-Guided Diffusion Models for 3D De Novo Molecular Design](computational_biology/uncertainty-aware_multi-objective_reinforcement_learning-guided_diffusion_models.md)**
...
**[Uncertainty-Guided Model Selection for Tabular Foundation Models in Biomolecule Efficacy Prediction](computational_biology/uncertainty-guided_model_selection_for_tabular_foundation_models_in_biomolecule_.md)**

:   本文提出OligoICP方法，利用TabPFN模型的预测分位数间距（IQR）作为无标签模型选择启发式指标，在siRNA敲低效率预测中实现了优于专用SOTA模型和朴素集成的性能。

**[Understanding and Enhancing Mask-Based Pretraining towards Universal Representations](computational_biology/understanding_and_enhancing_mask-based_pretraining_towards_universal_representat.md)**
...
**[Unified All-Atom Molecule Generation with Neural Fields](computational_biology/unified_all-atom_molecule_generation_with_neural_fields.md)**

:   提出 FuncBind 框架，利用神经场（Neural Fields）将分子表示为连续原子密度函数，构建统一的条件生成模型，能够同时处理小分子、大环肽和抗体 CDR 环三种药物模态的靶标条件生成。

**[UniSite: The First Cross-Structure Dataset and Learning Framework for End-to-End Ligand Binding Site Detection](computational_biology/unisite_the_first_cross-structure_dataset_and_learning_framework_for_end-to-end_.md)**
...
**[Variational Regularized Unbalanced Optimal Transport: Single Network, Least Action](computational_biology/variational_regularized_unbalanced_optimal_transport_single_network_least_action.md)**

:   提出 Var-RUOT，通过将正则化非平衡最优传输（RUOT）问题的最优性必要条件融入参数化和损失设计，仅需学习单个标量场即可求解 RUOT，获得更低作用量的解并提升训练稳定性；同时分析了增长惩罚函数对生物先验的影响。

**[Why Masking Diffusion Works: Condition on the Jump Schedule for Improved Discrete Diffusion](computational_biology/why_masking_diffusion_works_condition_on_the_jump_schedule_for_improved_discrete.md)**
...
**[EEGReXferNet: A Lightweight Gen-AI Framework for EEG Subspace Reconstruction via Cross-Subject Transfer Learning and Channel-Aware Embedding](medical_imaging/eegrexfernet_a_lightweight_gen-ai_framework_for_eeg_subspace_reconstruction_via_.md)**
...
**[EgoBridge: Domain Adaptation for Generalizable Imitation from Egocentric Human Data](robotics/egobridge_domain_adaptation_for_generalizable_imitation_from_egocentric_human_da.md)**
...
**[ESCA: Contextualizing Embodied Agents via Scene-Graph Generation](robotics/esca_contextualizing_embodied_agents_via_scene-graph_generation.md)**
...
**[Human-assisted Robotic Policy Refinement via Action Preference Optimization](robotics/human-assisted_robotic_policy_refinement_via_action_preference_optimization.md)**

:   提出 Action Preference Optimization (APO)，通过人机协作框架收集交互轨迹，利用基于前景理论的二元期望信号和自适应重加权方法对 VLA 模型进行偏好对齐优化，使其能从失败中学习并持续迭代改进。

**[Inner Speech as Behavior Guides: Steerable Imitation of Diverse Behaviors for Human-AI Coordination](robotics/inner_speech_as_behavior_guides_steerable_imitation_of_diverse_behaviors_for_hum.md)**
...
**[Learning Interactive World Model for Object-Centric Reinforcement Learning](robotics/learning_interactive_world_model_for_object-centric_reinforcement_learning.md)**

:   提出 FIOC-WM，通过对象级和属性级的两层分解学习世界模型中的物体交互结构，并基于交互原语训练层级策略，在多个机器人控制任务上实现了更高效的策略学习和组合泛化能力。

**[Learning Parameterized Skills from Demonstrations](robotics/learning_parameterized_skills_from_demonstrations.md)**
...
**[LUMIA: A Handheld Vision-to-Music System for Real-Time, Embodied Composition](robotics/lumia_a_handheld_vision-to-music_system_for_real-time_embodied_composition.md)**
...
**[Massively Parallel Imitation Learning of Mouse Forelimb Musculoskeletal Reaching Dynamics](robotics/massively_parallel_imitation_learning_of_mouse_forelimb_musculoskeletal_reaching.md)**
...
**[Memo: Training Memory-Efficient Embodied Agents with Reinforcement Learning](robotics/memo_training_memory-efficient_embodied_agents_with_reinforcement_learning.md)**
...
**[Memory-Augmented Potential Field Theory: A Framework for Adaptive Control in Non-Convex Domains](robotics/memory-augmented_potential_field_theory_a_framework_for_adaptive_control_in_non-.md)**
...
**[Opinion: Towards Unified Expressive Policy Optimization for Robust Robot Learning](robotics/opinion_towards_unified_expressive_policy_optimization_for_robust_robot_learning.md)**

:   提出 UEPO 框架，通过多种子动力学感知扩散策略、动态分歧正则化和基于扩散的数据增强三大核心组件，解决离线到在线强化学习中多模态行为覆盖不足和分布偏移问题，在 D4RL 基准上超越 Uni-O4。

**[Periodic Skill Discovery](robotics/periodic_skill_discovery.md)**
...
**[PROFIT: A Specialized Optimizer for Deep Fine Tuning](robotics/profit_a_specialized_optimizer_for_deep_fine_tuning.md)**

:   PROFIT 将微调视为时间维度上的多任务学习问题，通过将新任务梯度对"回归平衡点"方向做正交化投影，实现了无需额外数据或参数的抗遗忘微调优化器。

**[Provable Ordering and Continuity in Vision-Language Pretraining for Generalizable Embodied Agents](robotics/provable_ordering_and_continuity_in_vision-language_pretraining_for_generalizabl.md)**
...
**[Real-World Reinforcement Learning of Active Perception Behaviors](robotics/real-world_reinforcement_learning_of_active_perception_behaviors.md)**

:   提出非对称优势加权回归（AAWR），在训练时利用额外特权传感器来估计更准确的优势函数，从而高效学习真实世界中的主动感知策略，在8个涵盖不同部分可观测程度的操控任务上均超越所有基线方法。

**[Reinforcement Learning with Action Chunking](robotics/reinforcement_learning_with_action_chunking.md)**
...
**[Robot-R1: Reinforcement Learning for Enhanced Embodied Reasoning in Robotics](robotics/robot-r1_reinforcement_learning_for_enhanced_embodied_reasoning_in_robotics.md)**
...
**[SafeVLA: Towards Safety Alignment of Vision-Language-Action Model via Constrained Learning](robotics/safevla_towards_safety_alignment_of_vision-language-action_model_via_constrained.md)**

:   首次系统性地将安全强化学习（SafeRL）的 CMDP 框架应用于视觉-语言-动作模型（VLA）的安全对齐，通过建模-激发-约束-保证四阶段集成安全方法（ISA），在移动操作任务上实现 83.58% 的安全违规成本下降同时保持任务性能（+3.85%）。

**[Sample-Efficient Tabular Self-Play for Offline Robust Reinforcement Learning](robotics/sample-efficient_tabular_self-play_for_offline_robust_reinforcement_learning.md)**
...
**[Sample Complexity of Distributionally Robust Average-Reward Reinforcement Learning](robotics/sample_complexity_of_distributionally_robust_average-reward_reinforcement_learni.md)**
...
**[Self-Improving Embodied Foundation Models](robotics/self-improving_embodied_foundation_models.md)**
...
**[Spatial-Aware Decision-Making with Ring Attractors in Reinforcement Learning Systems](robotics/spatial-aware_decision-making_with_ring_attractors_in_reinforcement_learning_sys.md)**
...
**[STAIR: Addressing Stage Misalignment through Temporal-Aligned Preference Reinforcement Learning](robotics/stair_addressing_stage_misalignment_through_temporal-aligned_preference_reinforc.md)**
...
**[The Impact of Scaling Training Data on Adversarial Robustness](robotics/the_impact_of_scaling_training_data_on_adversarial_robustness.md)**
...
**[Time Reversal Symmetry for Efficient Robotic Manipulations in Deep Reinforcement Learning](robotics/time_reversal_symmetry_for_efficient_robotic_manipulations_in_deep_reinforcement.md)**

:   提出 TR-DRL 框架，利用机器人操作任务中的时间反转对称性——通过轨迹反转增强（完全可逆的转移）和时间反转引导的势函数奖励塑形（部分可逆的转移）——显著提升 DRL 在成对任务（如开门/关门）中的样本效率和最终性能。

**[To Distill or Decide? Understanding the Algorithmic Trade-off in Partially Observable Reinforcement Learning](robotics/to_distill_or_decide_understanding_the_algorithmic_trade-off_in_partially_observ.md)**
...
**[Trust Region Reward Optimization and Proximal Inverse Reward Optimization Algorithm](robotics/trust_region_reward_optimization_and_proximal_inverse_reward_optimization_algori.md)**

:   提出 TRRO 理论框架和 PIRO 实用算法，通过 Minorization-Maximization 过程保证 IRL 中奖励函数更新的单调改进，实现了逆强化学习领域类似于 TRPO/PPO 在正向 RL 中的稳定性保证。

**[VIKI-R: Coordinating Embodied Multi-Agent Cooperation via Reinforcement Learning](robotics/viki-r_coordinating_embodied_multi-agent_cooperation_via_reinforcement_learning.md)**
...
**[VolleyBots: A Testbed for Multi-Drone Volleyball Game Combining Motion Control and Strategic Play](robotics/volleybots_a_testbed_for_multi-drone_volleyball_game_combining_motion_control_an.md)**
...
**[Zero-Shot Context Generalization in Reinforcement Learning from Few Training Contexts](robotics/zero-shot_context_generalization_in_reinforcement_learning_from_few_training_con.md)**
...
**[Double Descent Meets Out-of-Distribution Detection: Theoretical Insights and Empirical Analysis](ai_safety/double_descent_meets_out-of-distribution_detection_theoretical_insights_and_empi.md)**
...
**[Generating Multi-Table Time Series EHR from Latent Space with Minimal Preprocessing](ai_safety/generating_multi-table_time_series_ehr_from_latent_space_with_minimal_preprocess.md)**
...
**[Harnessing Feature Resonance under Arbitrary Target Alignment for Out-of-Distribution Node Detection](ai_safety/harnessing_feature_resonance_under_arbitrary_target_alignment_for_out-of-distrib.md)**
...
**[Open-Insect: Benchmarking Open-Set Recognition of Novel Species in Biodiversity Monitoring](ai_safety/open-insect_benchmarking_open-set_recognition_of_novel_species_in_biodiversity_m.md)**
...
**[Redundancy-Aware Test-Time Graph Out-of-Distribution Detection](ai_safety/redundancy-aware_test-time_graph_out-of-distribution_detection.md)**

:   提出 RedOUT 框架，通过最小化结构熵构建编码树来消除图结构中的冗余信息，结合冗余感知图信息瓶颈(ReGIB)原理，在测试时无需修改预训练模型参数即可有效区分ID和OOD图样本，在10个数据集对上平均AUC达87.46%。

**[Revisiting Logit Distributions for Reliable Out-of-Distribution Detection](ai_safety/revisiting_logit_distributions_for_reliable_out-of-distribution_detection.md)**
...
**[SPROD: Spurious-Aware Prototype Refinement for Reliable Out-of-Distribution Detection](ai_safety/spurious-aware_prototype_refinement_for_reliable_out-of-distribution_detection.md)**
...
**[Towards Unsupervised Open-Set Graph Domain Adaptation via Dual Reprogramming](ai_safety/towards_unsupervised_open-set_graph_domain_adaptation_via_dual_reprogramming.md)**
...
**[Unlocking Transfer Learning for Open-World Few-Shot Recognition](ai_safety/unlocking_transfer_learning_for_open-world_few-shot_recognition.md)**
...
**[FlashMD: Long-Stride, Universal Prediction of Molecular Dynamics](physics/flashmd_long-stride_universal_prediction_of_molecular_dynamics.md)**

:   提出 FlashMD，基于 GNN 直接预测分子动力学轨迹的位置与动量跨步演化，实现比传统 MD 积分器大 1–2 个数量级的时间步长跨越，并在架构中融入哈密顿动力学约束，推广到任意热力学系综和通用化学体系。

**[From Black Hole to Galaxy: Neural Operator Framework for Accretion and Feedback Dynamics](physics/from_black_hole_to_galaxy_neural_operator_framework_for_accretion_and_feedback_d.md)**

:   提出基于 Neural Operator 的「子网格黑洞」模型，学习小尺度 (GR)MHD 时间演化算子，替代手工闭合规则嵌入多层级直接数值模拟框架，首次实现吸积驱动反馈的内禀变异性捕获，加速比达 $\sim 10^5$ 倍。

**[From Images to Physics: Probabilistic Inference of Galaxy Parameters and Emission Lines via VAE & Normalizing Flows](physics/from_images_to_physics_probabilistic_inference_of_galaxy_parameters_and_emission.md)**
...
**[Guided Diffusion Sampling on Function Spaces with Applications to PDEs](physics/guided_diffusion_sampling_on_function_spaces_with_applications_to_pdes.md)**
...
**[GyroSwin: 5D Surrogates for Gyrokinetic Plasma Turbulence Simulations](physics/gyroswin_5d_surrogates_for_gyrokinetic_plasma_turbulence_simulations.md)**
...
**[Hamiltonian Neural PDE Solvers through Functional Approximation](physics/hamiltonian_neural_pde_solvers_through_functional_approximation.md)**
...
**[High-order Equivariant Flow Matching for Density Functional Theory Hamiltonian Prediction](physics/high-order_equivariant_flow_matching_for_density_functional_theory_hamiltonian_p.md)**
...
**[INC: An Indirect Neural Corrector for Auto-Regressive Hybrid PDE Solvers](physics/inc_an_indirect_neural_corrector_for_auto-regressive_hybrid_pde_solvers.md)**
...
**[Integration Matters for Learning PDEs with Backward SDEs](physics/integration_matters_for_learning_pdes_with_backward_sdes.md)**
...
**[Multi-Trajectory Physics-Informed Neural Networks for HJB Equations with Hard-Zero Terminal Inventory: Optimal Execution on Synthetic & SPY Data](physics/multi-trajectory_physics-informed_neural_networks_for_hjb_equations_with_hard-ze.md)**
...
**[Neural Emulator Superiority: When Machine Learning for PDEs Surpasses its Training Data](physics/neural_emulator_superiority_when_machine_learning_for_pdes_surpasses_its_trainin.md)**

:   挑战了"神经 PDE 模拟器精度受限于训练数据（数值求解器）精度"的传统认知，发现并严格定义了 **emulator superiority** 现象——仅在低精度求解器数据上训练的神经网络，在以高精度参考解评估时竟能超越其训练求解器本身。

**[Neural Green's Functions](physics/neural_greens_functions.md)**
...
**[Neuro-Spectral Architectures for Causal Physics-Informed Networks](physics/neuro-spectral_architectures_for_causal_physics-informed_networks.md)**
...
**[One-Shot Transfer Learning for Nonlinear PDEs with Perturbative PINNs](physics/oneshot_transfer_learning_nonlinear_pdes_perturbative_pinns.md)**

:   将微扰理论与 PINNs 结合，将非线性PDE分解为线性子问题序列，用 Multi-Head PINN 学习线性算子的潜空间后，对新的PDE实例可通过闭式解在0.2秒内完成迁移，达到 $10^{-3}$ 量级误差。

**[Physics-Constrained Flow Matching: Sampling Generative Models with Hard Constraints](physics/physics-constrained_flow_matching_sampling_generative_models_with_hard_constrain.md)**
...
**[Physics-Guided Machine Learning for Uncertainty Quantification in Turbulence Models](physics/physics-guided_machine_learning_for_uncertainty_quantification_in_turbulence_mod.md)**

:   提出混合 ML–EPM 框架：用轻量 CNN 学习从 RANS 湍流动能场到 DNS 真值的修正映射，以此调制特征空间扰动法（EPM）的扰动幅度，在保持物理一致性的前提下将湍流模型不确定性估计的误差降低 1–2 个数量级。

**[Physics-Informed Neural Networks with Fourier Features and Attention-Driven Decoding](physics/physics-informed_neural_networks_with_fourier_features_and_attention-driven_deco.md)**
...
**[Scaling Laws and Pathologies of Single-Layer PINNs: Network Width and PDE Nonlinearity](physics/scaling_laws_and_pathologies_of_single-layer_pinns_network_width_and_pde_nonline.md)**

:   对单层PINN在典型非线性PDE上建立了经验缩放定律，发现了双重优化失败：宽度缩放病理（误差不随宽度下降）和复合病理（非线性加剧此失败），证明优化而非近似容量是主要瓶颈。

**[Score-informed Neural Operator for Enhancing Ordering-based Causal Discovery](physics/score-informed_neural_operator_for_enhancing_ordering-based_causal_discovery.md)**
...
**[Stable Minima of ReLU Neural Networks Suffer from the Curse of Dimensionality: The Neural Shattering Phenomenon](physics/stable_minima_of_relu_neural_networks_suffer_from_the_curse_of_dimensionality_th.md)**
...
**[Symbolic Regression Is All You Need: From Simulations to Scaling Laws in Binary Neutron Star Mergers](physics/symbolic_regression_is_all_you_need_from_simulations_to_scaling_laws_in_binary_n.md)**
...
**[The Primacy of Magnitude in Low-Rank Adaptation](physics/the_primacy_of_magnitude_in_low-rank_adaptation.md)**
...
**[Towards Universal Neural Operators through Multiphysics Pretraining](physics/towards_universal_neural_operators_through_multiphysics_pretraining.md)**
...
**[MedMKG: Benchmarking Medical Knowledge Exploitation with Multimodal Knowledge Graph](graph_learning/medmkg_benchmarking_medical_knowledge_exploitation_with_multimodal_knowledge_gra.md)**
...
**[NeuroPath: Neurobiology-Inspired Path Tracking and Reflection for Semantically Coherent Retrieval](graph_learning/neuropath_neurobiology-inspired_path_tracking_and_reflection_for_semantically_co.md)**
...
**[RAD: Towards Trustworthy Retrieval-Augmented Multi-modal Clinical Diagnosis](graph_learning/rad_towards_trustworthy_retrieval-augmented_multi-modal_clinical_diagnosis.md)**
...
**[Sound Logical Explanations for Mean Aggregation Graph Neural Networks](graph_learning/sound_logical_explanations_for_mean_aggregation_graph_neural_networks.md)**
...
**[Preference-based Reinforcement Learning beyond Pairwise Comparisons: Benefits of Multiple Options](llm_nlp/preference-based_reinforcement_learning_beyond_pairwise_comparisons_benefits_of_.md)**
...
**[The Last Vote: A Multi-Stakeholder Framework for Language Model Governance](llm_nlp/the_last_vote_a_multi-stakeholder_framework_for_language_model_governance.md)**
...
**[Towards Implicit Aggregation: Robust Image Representation for Place Recognition in the Transformer Era](llm_nlp/towards_implicit_aggregation_robust_image_representation_for_place_recognition_i.md)**
...
**[Composition and Alignment of Diffusion Models using Constrained Learning](llm_pretraining/composition_and_alignment_of_diffusion_models_using_constrai.md)**
...
**[Generating Physically Sound Designs from Text and a Set of Physical Constraints](llm_pretraining/generating_physically_sound_designs_from_text_and_a_set_of_physical_constraints.md)**
...
**[Heterogeneous Adversarial Play in Interactive Environments](llm_pretraining/heterogeneous_adversarial_play_in_interactive_environments.md)**
...
**[LCDB 1.1: A Database Illustrating Learning Curves Are More Ill-Behaved Than Previously Thought](llm_pretraining/lcdb_11_a_database_illustrating_learning_curves_are_more_ill-behaved_than_previo.md)**
...
**[Next Semantic Scale Prediction via Hierarchical Diffusion Language Models](llm_pretraining/next_semantic_scale_prediction_via_hierarchical_diffusion_language_models.md)**
...
**[Graph-based Neural Space Weather Forecasting](time_series/graph-based_neural_space_weather_forecasting.md)**
...
**[MIRA: Medical Time Series Foundation Model for Real-World Health Data](time_series/mira_medical_time_series_foundation_model_for_real-world_health_data.md)**
...
**[Neural Stochastic Flows: Solver-Free Modelling and Inference for SDE Solutions](time_series/neural_stochastic_flows_solver-free_modelling_and_inference_for_sde_solutions.md)**
...
**[OmniCast: A Masked Latent Diffusion Model for Weather Forecasting Across Time Scales](time_series/omnicast_a_masked_latent_diffusion_model_for_weather_forecasting_across_time_sca.md)**
...
**[Structured Sparse Transition Matrices to Enable State Tracking in State-Space Models](time_series/structured_sparse_transition_matrices_to_enable_state_tracking_in_state-space_mo.md)**
...
**[TiRex: Zero-Shot Forecasting Across Long and Short Horizons with Enhanced In-Context Learning](time_series/tirex_zero-shot_forecasting_across_long_and_short_horizons_with_enhanced_in-cont.md)**
...
**[Towards Self-Supervised Foundation Models for Critical Care Time Series](time_series/towards_self-supervised_foundation_models_for_critical_care_time_series.md)**
...
**[Enabling Differentially Private Federated Learning for Speech Recognition: Benchmarks, Adaptive Optimizers and Gradient Clipping](audio_speech/enabling_differentially_private_federated_learning_for_speech_recognition_benchm.md)**
...
**[From Black Box to Biomarker: Sparse Autoencoders for Interpreting Speech Models of Parkinson's Disease](audio_speech/from_black_box_to_biomarker_sparse_autoencoders_for_interpreting_speech_models_o.md)**
...
**[MGE-LDM: Joint Latent Diffusion for Simultaneous Music Generation and Source Extraction](audio_speech/mge-ldm_joint_latent_diffusion_for_simultaneous_music_generation_and_source_extr.md)**

:   提出 MGE-LDM，首个在统一的潜在扩散框架中同时实现音乐混合生成、部分生成（源补全）和文本驱动任意源提取的模型，通过联合建模混合-子混合-源三元组并利用扩散修复（inpainting）实现各任务。

**[MGAudio: Model-Guided Dual-Role Alignment for High-Fidelity Open-Domain Video-to-Audio Generation](audio_speech/model-guided_dual-role_alignment_for_high-fidelity_open-domain_video-to-audio_ge.md)**
...
**[Shallow Flow Matching for Coarse-to-Fine Text-to-Speech Synthesis](audio_speech/shallow_flow_matching_for_coarse-to-fine_text-to-speech_synthesis.md)**
...
**[ThinkSound: Chain-of-Thought Reasoning in Multimodal Large Language Models for Audio Generation and Editing](audio_speech/thinksound_chain-of-thought_reasoning_in_multimodal_large_language_models_for_au.md)**
...
**[Instant Video Models: Universal Adapters for Stabilizing Image-Based Networks](segmentation/instant_video_models_universal_adapters_for_stabilizing_image-based_networks.md)**
...
**[LongVPO: From Anchored Cues to Self-Reasoning for Long-Form Video Preference Optimization](video_understanding/longvpo_from_anchored_cues_to_selfreasoning_for_longform_vid.md)**
...
**[MoniTor: Exploiting Large Language Models with Instruction for Online Video Anomaly Detection](video_understanding/monitor_exploiting_large_language_models_with_instruction_for_online_video_anoma.md)**
...
**[PANDA: Towards Generalist Video Anomaly Detection via Agentic AI Engineer](video_understanding/panda_towards_generalist_video_anomaly_detection_via_agentic_ai_engineer.md)**
...
**[Self-alignment of Large Video Language Models with Refined Regularized Preference Optimization](video_understanding/self-alignment_of_large_video_language_models_with_refined_regularized_preferenc.md)**
...
**[VADTree: Explainable Training-Free Video Anomaly Detection via Hierarchical Granularity](video_understanding/vadtree_explainable_training-free_video_anomaly_detection_via_hierarchical_granu.md)**
...
**[ConTextTab: A Semantics-Aware Tabular In-Context Learner](llm_evaluation/contexttab_a_semantics-aware_tabular_in-context_learner.md)**
...
**[DSAS: A Universal Plug-and-Play Framework for Attention Optimization in Multi-Document Question Answering](llm_evaluation/dsas_a_universal_plug-and-play_framework_for_attention_optimization_in_multi-doc.md)**
...
**[MEMTRACK: Evaluating Long-Term Memory and State Tracking in Multi-Platform Dynamic Agent Environments](llm_evaluation/memtrack_evaluating_long-term_memory_and_state_tracking_in_multi-platform_dynami.md)**
...
**[Predicting the Performance of Black-Box LLMs through Follow-Up Queries](llm_evaluation/predicting_the_performance_of_black-box_llms_through_follow-up_queries.md)**
...
**[The Biased Oracle: Assessing LLMs' Understandability and Empathy in Medical Diagnoses](llm_evaluation/the_biased_oracle_assessing_llms_understandability_and_empathy_in_medical_diagno.md)**
...
**[Toward Engineering AGI: Benchmarking the Engineering Design Capabilities of LLMs](llm_evaluation/toward_engineering_agi_benchmarking_the_engineering_design_capabilities_of_llms.md)**
...
**[MMTU: A Massive Multi-Task Table Understanding and Reasoning Benchmark](self_supervised/mmtu_a_massive_multi-task_table_understanding_and_reasoning_benchmark.md)**
...
**[SegMASt3R: Geometry Grounded Segment Matching](self_supervised/segmast3r_geometry_grounded_segment_matching.md)**
...
**[Spend Wisely: Maximizing Post-Training Gains in Iterative Synthetic Data Bootstrapping](self_supervised/spend_wisely_maximizing_post-training_gains_in_iterative_synthetic_data_bootstra.md)**
...
**[FlowMoE: A Scalable Pipeline Scheduling Framework for Distributed Mixture-of-Experts Training](llm_efficiency/flowmoe_a_scalable_pipeline_scheduling_framework_for_distributed_mixture-of-expe.md)**
...
**[Harnessing the Computation Redundancy in ViTs to Boost Adversarial Transferability](llm_efficiency/harnessing_the_computation_redundancy_in_vits_to_boost_adversarial_transferabili.md)**
...
**[MoESD: Unveil Speculative Decoding's Potential for Accelerating Sparse MoE](llm_efficiency/moesd_unveil_speculative_decodings_potential_for_accelerating_sparse_moe.md)**
...
**[RGB-to-Polarization Estimation: A New Task and Benchmark Study](image_restoration/rgb-to-polarization_estimation_a_new_task_and_benchmark_study.md)**
...
**[Multimodal Generative Flows for LHC Jets](object_detection/multimodal_generative_flows_for_lhc_jets.md)**

:   提出基于 Transformer 的多模态流匹配框架（MMF），将连续流匹配与连续时间马尔可夫跳跃桥联合建模，实现对 LHC 喷注中粒子运动学（连续）和 flavor 量子数（离散）的统一生成。

**[Normal-Abnormal Guided Generalist Anomaly Detection](object_detection/normal-abnormal_guided_generalist_anomaly_detection.md)**
...
**[Scalable, Explainable and Provably Robust Anomaly Detection with One-Step Flow Matching](object_detection/scalable_explainable_and_provably_robust_anomaly_detection_with_one-step_flow_ma.md)**
...
**[ScatterAD: Temporal-Topological Scattering Mechanism for Time Series Anomaly Detection](object_detection/scatterad_temporal-topological_scattering_mechanism_for_time_series_anomaly_dete.md)**

:   提出"散射性"（scattering）作为异常检测的新归纳偏置——异常样本在高维表示空间中比正常样本分布更分散，通过双编码器（时间+拓扑）+ 超球面散射中心约束 + 对比融合学习时拓扑联合表示，在 6 个工业 IoT 数据集上 15/24 设置取得最佳。

**[Semi-supervised Graph Anomaly Detection via Robust Homophily Learning](object_detection/semi-supervised_graph_anomaly_detection_via_robust_homophily_learning.md)**

:   提出RHO (Robust Homophily Learning)方法，通过自适应频率响应滤波器(AdaFreq)和图正常性对齐(GNA)模块，解决半监督图异常检测中正常节点同质性多样性的问题，在8个真实数据集上超越现有方法。

**[Spatio-Temporal Graphs Beyond Grids: Benchmark for Maritime Anomaly Detection](object_detection/spatio-temporal_graphs_beyond_grids_benchmark_for_maritime_anomaly_detection.md)**

:   提出首个面向非网格时空系统（海事领域）的图异常检测基准数据集，将OMTAD数据集扩展为支持节点/边/图三级异常检测的基准，并计划使用LLM智能体进行轨迹合成和异常注入。

**[Stealthy Yet Effective: Distribution-Preserving Backdoor Attacks on Graph Classification](object_detection/stealthy_yet_effective_distribution-preserving_backdoor_attacks_on_graph_classif.md)**

:   提出 DPSBA，一种面向图分类的 clean-label 后门攻击框架，通过对抗训练生成分布内（in-distribution）触发子图，同时抑制结构异常和语义异常，在保持高攻击成功率的同时显著提升隐蔽性。

**[Structured Temporal Causality for Interpretable Multivariate Time Series Anomaly Detection](object_detection/structured_temporal_causality_for_interpretable_multivariate_time_series_anomaly.md)**
...
**[Redefining Experts: Interpretable Decomposition of Language Models for Toxicity Mitigation](social_computing/redefining_experts_interpretable_decomposition_of_language_models_for_toxicity_m.md)**
...
**[Uncovering Strategic Egoism Behaviors in Large Language Models](social_computing/uncovering_strategic_egoism_behaviors_in_large_language_models.md)**
...
**[Worse than Zero-shot? A Fact-Checking Dataset for Evaluating the Robustness of RAG Against Misleading Retrievals](social_computing/worse_than_zero-shot_a_fact-checking_dataset_for_evaluating_the_robustness_of_ra.md)**
...
**[Reasoning Models Hallucinate More: Factuality-Aware Reinforcement Learning for Large Reasoning Models](hallucination/reasoning_models_hallucinate_more_factuality-aware_reinforcement_learning_for_la.md)**
...
**[Robust Hallucination Detection in LLMs via Adaptive Token Selection](hallucination/robust_hallucination_detection_in_llms_via_adaptive_token_selection.md)**
...
**[SECA: Semantically Equivalent and Coherent Attacks for Eliciting LLM Hallucinations](hallucination/seca_semantically_equivalent_and_coherent_attacks_for_eliciting_llm_hallucinatio.md)**

:   提出 SECA（Semantically Equivalent and Coherent Attacks），通过保持语义等价和语义连贯性的现实主义提示修改来诱发 LLM 幻觉，在多选 QA 任务上实现更高攻击成功率且几乎无语义错误。

**[Seeing is Believing? Mitigating OCR Hallucinations in Multimodal Large Language Models](hallucination/seeing_is_believing_mitigating_ocr_hallucinations_in_multimodal_large_language_m.md)**

:   针对多模态大模型在退化文档场景下的OCR幻觉问题，提出首个退化文档幻觉评测基准KIE-HVQA，并设计基于GRPO的多目标奖励强化学习框架，在7B参数模型上实现比GPT-4o高约28%的幻觉抑制准确率提升。

**[Systematic Reward Gap Optimization for Mitigating VLM Hallucinations](hallucination/systematic_reward_gap_optimization_for_mitigating_vlm_hallucinations.md)**
...
**[Teaming LLMs to Detect and Mitigate Hallucinations](hallucination/teaming_llms_to_detect_and_mitigate_hallucinations.md)**
...
**[When Semantics Mislead Vision: Mitigating Large Multimodal Models Hallucinations](hallucination/when_semantics_mislead_vision_mitigating_large_multimodal_models_hallucinations_.md)**
...
**[MAS-ZERO: Designing Multi-Agent Systems with Zero Supervision](multi_agent/maszero_designing_multiagent_systems_with_zero_supervision.md)**
...
**[MedAgentBoard: Benchmarking Multi-Agent Collaboration with Conventional Methods for Diverse Medical Tasks](multi_agent/medagentboard_benchmarking_multi-agent_collaboration_with_conventional_methods_f.md)**

:   提出 MedAgentBoard，一个系统评估多智能体协作、单 LLM 和传统方法在多样化医学任务上表现的综合基准，揭示多智能体协作并不总是优于强单模型或专用传统方法。

**[MetaMind: Modeling Human Social Thoughts with Metacognitive Multi-Agent Systems](multi_agent/metamind_modeling_human_social_thoughts_with_metacognitive_multi-agent_systems.md)**
...
**[Multi-Agent Collaboration via Evolving Orchestration](multi_agent/multi-agent_collaboration_via_evolving_orchestration.md)**

:   提出"木偶师"(Puppeteer)式多 Agent 协作范式——一个中心化编排器通过 RL 学习在每个推理步骤动态选择激活哪个 Agent，在封闭域和开放域任务上同时提升性能和效率，并发现演化后的拓扑趋向更紧凑的环形结构。

**[R&D-Agent-Quant: A Multi-Agent Framework for Data-Centric Factors and Model Joint Optimization](multi_agent/rd-agent-quant_a_multi-agent_framework_for_data-centric_factors_and_model_joint_.md)**
...
**[The PokeAgent Challenge: Competitive and Long-Context Learning at Scale](multi_agent/the_pokeagent_challenge_competitive_and_long-context_learning_at_scale.md)**

:   提出 PokéAgent Challenge，一个基于宝可梦对战和RPG速通的双赛道大规模AI基准，通过NeurIPS 2025竞赛验证了专家RL方法远超通用LLM方法，并揭示宝可梦对战衡量的能力与现有49个LLM基准近乎正交。

**[Thought Communication in Multiagent Collaboration](multi_agent/thought_communication_in_multiagent_collaboration.md)**
...
**[RAxSS: Retrieval-Augmented Sparse Sampling for Explainable Variable-Length Medical Time Series Classification](medical_nlp/raxss_retrieval-augmented_sparse_sampling_for_explainable_variable-length_medica.md)**

:   提出RAxSS框架，将检索增强机制引入随机稀疏采样(SSS)流水线，通过窗口内相似度加权聚合替代均匀平均，在保持变长医学时间序列分类性能的同时提供从"哪里"到"为什么"的可解释性证据链。

**[Shallow Robustness, Deep Vulnerabilities: Multi-Turn Evaluation of Medical LLMs](medical_nlp/shallow_robustness_deep_vulnerabilities_multi-turn_evaluation_of_medical_llms.md)**

:   提出MedQA-Followup框架系统评估医学LLM的多轮鲁棒性，发现模型在单轮扰动下表现尚可（浅层鲁棒性），但在多轮追问中准确率可从91.2%暴跌至13.5%（深层脆弱性），且间接上下文操纵比直接错误建议更具破坏力。

**[The Physical Basis of Prediction: World Model Formation in Neural Organoids via an LLM-Generated Curriculum](medical_nlp/the_physical_basis_of_prediction_world_model_formation_in_neural_organoids_via_a.md)**

:   本文提出在人类神经类器官（organoids）中研究世界模型形成的框架，设计了三个渐进式虚拟环境（条件回避、捕食者-猎物、Pong），并引入 LLM 自动生成实验方案的元学习方法，结合多尺度生物物理评估策略量化生物学习的物理基础。

**[Time-IMM: A Dataset and Benchmark for Irregular Multimodal Multivariate Time Series](medical_nlp/time-imm_a_dataset_and_benchmark_for_irregular_multimodal_multivariate_time_seri.md)**
...
**[Bispectral OT: Dataset Comparison using Symmetry-Aware Optimal Transport](others/bispectral_ot_dataset_comparison_using_symmetry-aware_optimal_transport.md)**
...
**[Diffusion Transformers for Imputation: Statistical Efficiency and Uncertainty Quantification](others/diffusion_transformers_for_imputation_statistical_efficiency_and_uncertainty_qua.md)**
...
**[egoEMOTION: Egocentric Vision and Physiological Signals for Emotion and Personality Recognition in Real-World Tasks](others/egoemotion_egocentric_vision_and_physiological_signals_for_emotion_and_personali.md)**
...
**[Estimation of Stochastic Optimal Transport Maps](others/estimation_of_stochastic_optimal_transport_maps.md)**
...
**[Fixed-Point RNNs: Interpolating from Diagonal to Dense](others/fixed-point_rnns_interpolating_from_diagonal_to_dense.md)**
...
**[Improving Time Series Forecasting via Instance-aware Post-hoc Revision (PIR)](others/improving_time_series_forecasting_via_instance-aware_post-hoc_revision.md)**
...
**[InFlux: A Benchmark for Self-Calibration of Dynamic Intrinsics of Video Cameras](others/influx_a_benchmark_for_self-calibration_of_dynamic_intrinsics_of_video_cameras.md)**
...
**[Manipulating Feature Visualizations with Gradient Slingshots](others/manipulating_feature_visualizations_with_gradient_slingshots.md)**
...
**[Merlin L48 Spectrogram Dataset](others/merlin_l48_spectrogram_dataset.md)**
...
**[Model-Behavior Alignment under Flexible Evaluation: When the Best-Fitting Model Isn't the Right One](others/model-behavior_alignment_under_flexible_evaluation_when_the_best-fitting_model_i.md)**
...
**[Put CASH on Bandits: A Max K-Armed Problem for Automated Machine Learning](others/put_cash_on_bandits_a_max_k-armed_problem_for_automated_machine_learning.md)**
...
**[RDB2G-Bench: A Comprehensive Benchmark for Automatic Graph Modeling of Relational Databases](others/rdb2g-bench_a_comprehensive_benchmark_for_automatic_graph_modeling_of_relational.md)**
...
**[Reliably Detecting Model Failures in Deployment Without Labels](others/reliably_detecting_model_failures_in_deployment_without_labels.md)**
...
**[Rethinking Evaluation of Infrared Small Target Detection](others/rethinking_evaluation_of_infrared_small_target_detection.md)**

:   系统性地揭示了红外小目标检测（IRSTD）现有评估协议的三大局限，提出包含混合层级指标hIoU、系统化错误分析方法和跨数据集评估设置的层次化分析框架。

**[Rethinking Losses for Diffusion Bridge Samplers](others/rethinking_losses_for_diffusion_bridge_samplers.md)**
...
**[Revisiting Bi-Linear State Transitions in Recurrent Neural Networks](others/revisiting_bi-linear_state_transitions_in_recurrent_neural_networks.md)**
...
**[Semi-Supervised Regression with Heteroscedastic Pseudo-Labels](others/semi-supervised_regression_with_heteroscedastic_pseudo-labels.md)**
...
**[SynTSBench: Rethinking Temporal Pattern Learning in Deep Learning Models for Time Series](others/syntsbench_rethinking_temporal_pattern_learning_in_deep_learning_models_for_time.md)**

:   提出SynTSBench合成数据驱动评估范式，通过可编程的特征配置和理论最优基准，系统评估时间序列预测模型在趋势、周期、依赖性、噪声鲁棒性等维度的实际建模能力。

**[Test-Time Adaptation by Causal Trimming](others/test-time_adaptation_by_causal_trimming.md)**
...
**[The Geometry of Cortical Computation: Manifold Disentanglement and Predictive Dynamics in VCNet](others/the_geometry_of_cortical_computation_manifold_disentanglement_and_predictive_dyn.md)**
...
**[Tight Lower Bounds and Improved Convergence in Performative Prediction](others/tight_lower_bounds_and_improved_convergence_in_performative_prediction.md)**
...
**[TrackingWorld: World-centric Monocular 3D Tracking of Almost All Pixels](others/trackingworld_world-centric_monocular_3d_tracking_of_almost_all_pixels.md)**
...
**[Turbocharging Gaussian Process Inference with Approximate Sketch-and-Project](others/turbocharging_gaussian_process_inference_with_approximate_sketch-and-project.md)**
...
**[What Does It Take to Build a Performant Selective Classifier?](others/what_does_it_take_to_build_a_performant_selective_classifier.md)**

:   首次对选择性分类的性能差距（selective classification gap）进行有限样本分解，将差距归因于五个源头——贝叶斯噪声、逼近误差、排序误差、统计噪声和实现偏差，并证明单调校准方法对缩小差距效果有限。

**[xLSTM-Mixer: Multivariate Time Series Forecasting by Mixing via Scalar Memories](others/xlstm-mixer_multivariate_time_series_forecasting_by_mixing_via_scalar_memories.md)**
