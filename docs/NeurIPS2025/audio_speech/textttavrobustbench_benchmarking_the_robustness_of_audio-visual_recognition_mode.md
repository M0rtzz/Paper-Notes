...
description: >-
  [NeurIPS 2025][音频/语音][音视频鲁棒性] 提出 AVRobustBench，首个系统评估音视频模型在 双模态共现关联腐蚀：下测试时鲁棒性的基准，包含 4 个数据集 × 75 种腐蚀，并提出基于低熵样本筛选的 TTA 方法 AV2C。 领域现状： UAVM、CAV-MAE、ImageBind 等音视频模型取得…
tags:
  - "NeurIPS 2025"
  - "音频/语音"
  - "音视频鲁棒性"
