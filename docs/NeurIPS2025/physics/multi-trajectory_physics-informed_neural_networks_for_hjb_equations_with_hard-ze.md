...
description: >-
  [NeurIPS 2025 (Workshop on Generative AI in Finance)][物理/科学计算][Physics-Informed Neural Networks] 针对最优交易执行中 HJB 方程的硬零终端库存约束（$X_T=0$），提出 Multi-Trajectory PINN (MT-PINN)…
tags:
