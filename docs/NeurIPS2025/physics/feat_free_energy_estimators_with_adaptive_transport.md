...
description: >-
  [NeurIPS 2025][物理/科学计算][自由能估计] 提出 FEAT 框架，利用随机插值学习两个热力学系统之间的传输映射，基于 escorted Jarzynski 等式和 controlled Crooks 定理提供一致、最小方差的自由能差估计器及变分上下界，统一了平衡与非平衡方法。 现有痛点 现有痛点：自由能估计…
tags:
  - "NeurIPS 2025"
  - "物理/科学计算"
  - "自由能估计"
