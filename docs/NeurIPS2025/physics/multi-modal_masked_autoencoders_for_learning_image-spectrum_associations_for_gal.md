...
description: >-
  [NeurIPS 2025][物理/科学计算][多模态掩码自编码器] 构建了包含 134,533 个星系的图像-光谱-红移多模态数据集（GalaxiesML-Spectra），适配多模态掩码自编码器（MMAE）同时进行图像和光谱的联合重建与红移回归，证明在测试时即使光谱完全缺失，仅用 25% 掩码图像即可实现优于 AstroCLIP 的红移预测散度 $\sigma_{NMAD} = 0.016$。
tags:
  - "NeurIPS 2025"
  - "物理/科学计算"
  - "多模态掩码自编码器"
