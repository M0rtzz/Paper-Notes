...
description: >-
  [NeurIPS 2025][物理/科学计算][zero-knowledge proof] 提出PHAZE框架，利用密码学哈希（Rabin指纹）和零知识机器学习（zkML）实现LHC触发器级别的可验证早退出推理，理论延迟降至~152-253ns量级，同时内建异常检测能力。 领域现状：大型强子对撞机（LHC）以40MHz频率产…
tags:
  - "NeurIPS 2025"
  - "物理/科学计算"
