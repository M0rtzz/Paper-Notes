...
description: >-
  [NeurIPS 2025][物理/科学计算][LLM嵌入] 探究LLM嵌入是否能编码从X射线天文观测导出的物理量（硬度比、幂律指数、变异性），发现结构化prompt设计可将物理属性聚类纯度提升5.9%-57.5%，稀疏自编码器揭示LLM通过识别天体类型来推断未显式给出的物理参数。 领域现状：LLM展现跨领域泛化能力…
tags:
  - "NeurIPS 2025"
  - "物理/科学计算"
  - "LLM嵌入"
