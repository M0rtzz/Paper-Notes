...
description: >-
  [NeurIPS 2025][LLM Agent][knowledge discovery] 通过让 LLM Agent 控制模拟化学反应器（黑盒函数），证明 Agent 能在无先验知识下通过试错探索、发现并总结未知化学系统的规则，揭示了 Agent 进行开放式科学发现的能力与局限。 LLM Agent 在材料科学中的应用主…
tags:
  - "NeurIPS 2025"
  - "LLM Agent"
  - "knowledge discovery"
