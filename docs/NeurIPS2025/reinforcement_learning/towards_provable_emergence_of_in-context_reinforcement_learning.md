...
description: >-
  [NeurIPS 2025][强化学习][In-Context RL] 本文从理论上证明了 Transformer 经过标准 RL 预训练后，其全局最优参数能够实现 in-context temporal difference (TD) 学习，为 in-context RL (ICRL) 现象提供了首个可证明的理论支撑。
tags:
  - "NeurIPS 2025"
  - "强化学习"
  - "In-Context RL"
