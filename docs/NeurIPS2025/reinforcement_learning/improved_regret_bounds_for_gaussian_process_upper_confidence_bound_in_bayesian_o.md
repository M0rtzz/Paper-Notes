...
description: >-
  [NeurIPS 2025][强化学习][Bayesian optimization] 本文证明 GP-UCB 在贝叶斯设定下可达 $\widetilde{O}(\sqrt{T})$ 高概率 regret（Matern 核满足光滑条件时）和 $O(\sqrt{T \ln^2 T})$（SE 核），弥合了 GP-UCB 已有上界与最优上界间的差距。
tags:
  - "NeurIPS 2025"
  - "强化学习"
