...
description: >-
  [NeurIPS 2025][强化学习][微分强化学习] 将RL问题通过连续时间控制的微分对偶形式重新表述，利用哈密顿结构嵌入物理先验，提出dfPO算法实现逐点策略优化，在科学计算任务（曲面建模、网格控制、分子动力学）上以更少样本超越12个RL基线。 RL在科学计算领域面临三大瓶颈：(1) 样本效率差——科学仿真代价高昂…
tags:
  - "NeurIPS 2025"
  - "强化学习"
  - "微分强化学习"
