...
description: >-
  [NeurIPS 2025][医学图像][可解释性] 提出 Induction-Gram (GIM)，一种结合精确n-gram匹配与模糊匹配的可解释语言模型，通过构建"广义归纳头"在输入上下文中检索相似序列进行下一token预测，比可解释基线提升最高25%p准确率，并在fMRI脑响应预测中提升20%。
tags:
  - NeurIPS 2025
  - 医学图像
  - 可解释性
...
- [\[ICML 2025\] Roll the Dice & Look Before You Leap: Going Beyond the Creative Limits of Next-Token Prediction](../../ICML2025/medical_imaging/roll_the_dice_look_before_you_leap_going_beyond_the_creative_limits_of_next-toke.md)
