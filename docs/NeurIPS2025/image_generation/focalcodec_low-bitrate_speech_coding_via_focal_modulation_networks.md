...
- [Label-Efficient Hyperspectral Image Classification via Spectral FiLM Modulation of Low-Level Pretrained Diffusion Features](../../ICML2025/image_generation/label-efficient_hyperspectral_image_classification_via_spectral_film_modulation_.md)
