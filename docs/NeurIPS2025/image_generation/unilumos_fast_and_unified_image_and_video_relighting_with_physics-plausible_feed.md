...
description: >-
  [NeurIPS 2025][图像生成][重光照] 提出UniLumos，一个统一的图像和视频重光照框架，通过在flow matching骨干中引入RGB空间的深度和法线几何反馈来增强物理合理性，同时借助路径一致性学习实现20倍加速。 重光照（Relighting）是计算机视觉和图形学中的重要任务，需要在改变光照的同时保持场…
tags:
  - "NeurIPS 2025"
  - "图像生成"
  - "重光照"
