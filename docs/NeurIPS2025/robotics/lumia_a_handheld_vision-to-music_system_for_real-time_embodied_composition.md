...
description: >-
  [NeurIPS 2025][机器人][视觉转音乐] 提出Lumia——一个手持相机式设备，通过GPT-4 Vision分析拍摄画面生成结构化提示，再由Stable Audio合成音乐循环段，实现从视觉到音乐的实时、具身化即兴创作工作流。 领域现状：生成式AI在文本、图像、音频领域均有突破（DALL·E、MusicLM、St…
tags:
  - "NeurIPS 2025"
  - "机器人"
  - "视觉转音乐"
