...
description: >-
  [NeurIPS 2025][优化/理论][迁移学习] 提出了首个针对Wasserstein空间中概率分布输出的迁移学习框架（WaTL），通过加权辅助估计、偏差校正和投影三步法，结合自适应信息源选择，从源域迁移知识以提升目标域分布回归的估计性能。 迁移学习在图像、文本等欧氏空间数据上已取得巨大成功，但现有方法几乎都假设数据位…
tags:
  - "NeurIPS 2025"
  - "优化/理论"
  - "迁移学习"
