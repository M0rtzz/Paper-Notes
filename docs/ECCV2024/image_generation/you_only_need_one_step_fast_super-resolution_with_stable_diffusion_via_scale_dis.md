...
description: >-
  [ECCV 2024][图像生成][单步超分辨率] 提出YONOS-SR方法，通过尺度蒸馏（Scale Distillation）策略训练基于Stable Diffusion的超分辨率模型，仅需一步DDIM即可获得SOTA结果，速度比传统方法快200倍。 基于扩散模型的图像超分辨率（SR）方法在感知质量方面取得了突出的效果…
tags:
  - "ECCV 2024"
  - "图像生成"
  - "单步超分辨率"
