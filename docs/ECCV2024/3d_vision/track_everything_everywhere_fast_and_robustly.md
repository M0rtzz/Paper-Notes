...
description: >-
  [ECCV 2024][3D视觉] 提出一种高效鲁棒的测试时优化像素跟踪方法，通过引入CaDeX++可逆变形网络、单目深度先验和DINOv2长期语义一致性，将训练速度提升10倍以上，同时显著提高了跟踪精度和鲁棒性。 领域现状 领域现状：OmniMotion是当前SOTA的优化式跟踪方法，但存在三大问题：训练时间过长、对随机种…
tags:
  - "ECCV 2024"
  - "3D视觉"
---
