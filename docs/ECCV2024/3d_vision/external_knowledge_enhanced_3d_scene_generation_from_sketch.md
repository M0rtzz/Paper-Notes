...
description: >-
  [ECCV 2024][3D视觉][3D场景生成] 提出SEK框架，结合手绘草图和外部物体关系知识库作为扩散模型的条件，通过知识增强图推理和频谱滤波器，端到端地同时生成3D室内场景的布局和物体几何形状。 领域现状： 3D场景生成在游戏开发、电影制作、AR/VR和室内设计等领域需求日益增长。现有方法主要依赖图像、文本、场景图或…
tags:
  - "ECCV 2024"
  - "3D视觉"
  - "3D场景生成"
