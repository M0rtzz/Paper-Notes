...
description: >-
  [ECCV 2024][自动驾驶][半监督学习] 提出IT2框架，通过利用LiDAR数据的对等表示（range image + voxel grid）之间的一致性学习作为新型扰动形式，并引入基于高斯混合模型的跨分布对比学习，大幅提升半监督LiDAR语义分割性能。 领域现状：户外LiDAR语义分割是自动驾驶的基础任务…
tags:
  - "ECCV 2024"
  - "自动驾驶"
  - "半监督学习"
