...
description: >-
  [ECCV 2024][多模态VLM][高分辨率VLM] 提出 FlexAttention，通过基于注意力图的高分辨率token动态选择和层次化自注意力融合机制，在保持甚至超越现有高分辨率VLM性能的同时，将计算成本降低近40%。 领域现状：主流VLM（如LLaVA-1.5、InstructBLIP）通常将输入图像限制在较低…
tags:
  - "ECCV 2024"
  - "多模态VLM"
  - "高分辨率VLM"
