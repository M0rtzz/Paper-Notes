...
description: >-
  [ECCV 2024][自监督学习][红外基础模型] 提出 InfMAE——首个红外模态基础模型，构建了 30 万张红外图像数据集 Inf30，设计信息感知掩码策略和多尺度编码器，在红外语义分割、目标检测和小目标检测三个下游任务上超越现有方法。 红外成像利用物体热辐射成像，在低光照、黑暗、烟雾等恶劣条件下具有不可替代的优势…
tags:
  - "ECCV 2024"
  - "自监督学习"
  - "红外基础模型"
