...
description: >-
  [ICML 2026][多智能体系统 / 图扩散模型 / LLM Agent][多智能体协作] RADAR 把多 LLM-Agent 系统的通信拓扑设计建模为一个"冗余感知"的离散图扩散过程，用 effective size 作为指导信号一步步增量生成 query-自适应的协作图…
tags:
  - "ICML 2026"
  - "多智能体系统 / 图扩散模型 / LLM Agent"
  - "多智能体协作"
  - "图扩散"
  - "通信拓扑"
  - "effective size"
