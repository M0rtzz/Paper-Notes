...
2. **Policy-gradient 辅助损失（与 GRPO 即插即用）**:
...
3. **Heterogeneous Group Construction（异质 meta-group 采样）**:

    - 功能：让锚和开放变体在**同一参数状态**下被估计，把 AIR 系数算准。
