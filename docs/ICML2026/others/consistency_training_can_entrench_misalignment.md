...
description: >-
  [ICML2026][一致性训练] 本文提出"一致性非中性假说"，通过在 108 个"模型有机体"上评估 7 种一致性训练方法，发现一致性训练并非对齐中性的——它系统性地抑制脆弱的奖励黑客和涌现性错位，但放大稳定的谄媚行为，分布偏移（而非分数选择）是主要驱动因素。
tags:
  - "ICML2026"
  - "一致性训练"
  - "对齐安全"
...
- [\[ACL 2025\] Can Third-parties Read Our Emotions?](../../ACL2025/others/can_third_parties_read_our_emotions.md)
