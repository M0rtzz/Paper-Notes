...
description: >-
  [ICML 2026][推荐系统][测试时对齐] T-POP 把"测试时对齐"和"神经决斗赌博机"拼在一起，在不动 LLM 参数的前提下，用每轮一对回复的在线偏好反馈在线学习个性化奖励函数，从而解决新用户个性化的冷启动问题。 领域现状：LLM 个性化目前主要走两条路。一条是 RLHF/DPO 式微调，按每个用户偏好重训或 L…
tags:
  - "ICML 2026"
  - "推荐系统"
  - "测试时对齐"
