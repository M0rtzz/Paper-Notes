...
description: >-
  [ICML 2026][多语言/翻译][Matryoshka 表征学习] ML-Embed 把 Matryoshka 思想从一维 (representation 维度) 扩展到**三维** —— 在 embedding 参数 (MEL)、模型深度 (MLL)、表征维度 (MRL) 上**全栈嵌套训练**…
tags:
  - "ICML 2026"
  - "多语言/翻译"
  - "Matryoshka 表征学习"
...
- [\[ACL 2025\] LEMONADE: A Large Multilingual Expert-Annotated Abstractive Event Dataset for the Real World](../../ACL2025/multilingual_mt/lemonade_a_large_multilingual_expert-annotated_abstractive_event_dataset_for_the.md)
