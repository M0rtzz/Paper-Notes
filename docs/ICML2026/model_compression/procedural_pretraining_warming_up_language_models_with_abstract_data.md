...
description: >-
  [ICML 2026][模型压缩][程序化数据] 在标准语言/代码/数学预训练之前插入一段极轻量的"程序化数据"（形式语言、栈、元胞自动机等）"预热"，仅 0.1–0.3% 额外 token 就能稳定提升下游性能，并让模型用 55–86% 的原始数据复现同等 loss——是一种把"推理脚手架"和"知识"解耦的预训练策略。
tags:
  - "ICML 2026"
  - "模型压缩"
  - "程序化数据"
