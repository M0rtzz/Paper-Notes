...
description: >-
  [ICML 2026][LLM Agent][多模态融合] 针对集中式多模态融合带来的"模态主导"和"虚假模态耦合"两个痼疾，GCL 把多模态学习重写为**两阶段四 agent 的协议化协作**：第一阶段由 Routing/Auditing agent 用边际预测增益逐样本决定哪些跨模态交流被允许…
tags:
  - "ICML 2026"
  - "LLM Agent"
  - "多模态融合"
...
- [\[ACL 2026\] LLM-Based Human-Agent Collaboration and Interaction Systems: A Survey](../../ACL2026/llm_agent/llm-based_human-agent_collaboration_and_interaction_systems_a_survey.md)
