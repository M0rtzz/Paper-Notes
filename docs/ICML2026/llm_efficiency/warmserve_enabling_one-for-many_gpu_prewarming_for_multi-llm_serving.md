...
description: >-
  [ICML 2026][LLM效率][GPU 预热] WarmServe 通过分析 LLM 服务工作负载的长期周期性规律，主动将多个模型参数预加载到 GPU，配合优化的放置算法和动态 KV 缓存预留策略，使系统能在请求突发时快速启动新实例——尾部 TTFT 相比现有系统降低 50.8 倍。 领域现状：多 LLM 服务系统需在…
tags:
  - "ICML 2026"
  - "LLM效率"
  - "GPU 预热"
