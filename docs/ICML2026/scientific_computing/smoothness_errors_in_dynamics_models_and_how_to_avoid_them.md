...
description: >-
  [ICML 2026][科学计算][图神经网络] 作者从理论上指出 Kiani 等人的 "unitary GNN" 因为强行保持 Rayleigh 商而对热扩散这类"天然会变光滑"的物理系统过度约束…
tags:
  - "ICML 2026"
  - "科学计算"
  - "图神经网络"
...
1. **Taylor 截断的松弛 Lie 卷积 R-UniGraph**:
...
3. **Mesh Rayleigh 商与 Robust Laplacian 上的 unitary 卷积**:
