...
description: >-
  [ACL2026][知识编辑][表示干预] 这篇论文提出 RILKE，把终身知识编辑从“改模型权重”转成“在隐藏表示空间施加低秩干预”，通过鲁棒训练、查询自适应路由和共享子空间模块，在 1,000 次非结构化知识编辑后仍保持接近满分的编辑成功率和较好的泛化能力，同时显著降低存储开销。 领域现状：LLM 的参数知识一旦训练完成…
tags:
  - "ACL2026"
  - "知识编辑"
  - "表示干预"
