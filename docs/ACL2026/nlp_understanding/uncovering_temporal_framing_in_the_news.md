...
title: >-
  [论文解读] 新闻文本中的时间框架揭示
description: >-
  [ACL 2026 Oral][NLP理解][时间框架] 本文提出了新闻文本中"时间框架"的概念——从社会科学理论出发，建立包含 8 类时间框架的分类体系，标注了英德双语新闻语料库，并用有监督和零样本两种方式训练模型进行时间框架检测。 领域现状：NLP 中的时间处理传统上聚焦于时间表达式抽取、事件排序、时间推理等任务…
tags:
  - "ACL 2026 Oral"
  - "NLP理解"
  - "时间框架"
