...
description: >-
  [ACL 2026][NLP理解][法律关系抽取] 构建了首个中国民事法律关系的结构化分类体系（9 大领域、265 种关系类型），并基于此提出 LexRel 基准（1,140 个专家标注样本），评估了主流 LLM 在法律关系抽取任务上的能力，发现当前模型在该任务上存在显著局限，同时证明了法律关系信息对下游法律 AI 任务的增益效果。
tags:
  - "ACL 2026"
  - "NLP理解"
  - "法律关系抽取"
