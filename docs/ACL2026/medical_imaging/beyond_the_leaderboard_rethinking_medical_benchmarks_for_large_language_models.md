...
description: >-
  [ACL 2026][医学图像][MedCheck] 作者提出 MedCheck——首个面向医学 LLM benchmark **生命周期**的评估框架，把 benchmark 构建拆成 5 个阶段共 46 条标准，用它对 56 个医学 benchmark 做审计…
tags:
  - "ACL 2026"
  - "医学图像"
  - "MedCheck"
...
2. **46 条医学专属评估准则**:
    ...
    - 设计动机：和 BetterBench 的差别在于这 46 条**全是医学场景特化**——HIPAA、ICD、临床指南、患者安全、医生 in-the-loop 等术语贯穿其中。让评估结果对医疗从业者可读。
