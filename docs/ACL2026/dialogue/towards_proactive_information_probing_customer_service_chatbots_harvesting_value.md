...
description: >-
  [ACL 2026 Findings][对话系统][主动信息探测] 本文提出 ProChatIP 框架，将客服聊天机器人从被动应答工具转变为主动信息采集引擎，通过专门的对话策略模块学习"何时探测"用户以获取预设的目标信息，同时最小化对话轮数和用户摩擦。 领域现状：AI 客服聊天机器人已成为现代商业运营的重要组成部分…
tags:
  - "ACL 2026 Findings"
  - "对话系统"
  - "主动信息探测"
