...
description: >-
  [ACL2026][对话系统][教育AI] 这篇论文提出 6 个面向教育 AI 对话的可计算行为指标，并在 500 段真实学生-AI 对话中发现：学生常把本应促进学习的 LLM 工具用成答案提取器，且部署方式比系统设计或学生偏好更能决定这种错位。 领域现状：教育 NLP 和 AI tutor 论文通常用满意度问卷、参与度、消…
tags:
  - "ACL2026"
  - "对话系统"
  - "教育AI"
