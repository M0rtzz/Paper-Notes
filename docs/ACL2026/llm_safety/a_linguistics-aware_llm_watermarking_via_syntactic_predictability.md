...
**1. Linguistic Indeterminacy $\lambda(c_t)$：把"调制信号"从模型空间搬到语言空间**
...
**2. Adaptive Insertion $\delta'_t = \delta \cdot \lambda(c_t)$：让水印"随波逐流"地嵌进文本**
...
**3. Adaptive Detection：把同一套 $\lambda$ 权重搬到检测端的加权 z-score**
