...
description: >-
  [ACL 2026][LLM安全][TDA] TOHA 把 LLM 的 attention 矩阵当成带权图，用拓扑数据分析里的 Manifold Topology Divergence 度量「response 子图相对 prompt 子图的拓扑新颖度」…
tags:
  - "ACL 2026"
  - "LLM安全"
  - "TDA"
...
1. **Attention as Weighted Graph + 拓扑散度 MTop-Div$_G$(R,P)**:
...
2. **Hallucination-Aware Heads 发现**:
