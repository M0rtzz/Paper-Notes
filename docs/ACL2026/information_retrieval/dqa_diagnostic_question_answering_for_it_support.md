...
description: >-
  [ACL 2026][信息检索/RAG][诊断式问答] 本文提出DQA框架，通过维护持久化的诊断状态和在根因层面聚合检索证据（而非逐文档处理），实现企业IT支持场景下的系统化故障排查，成功率从基线41.3%提升至78.7%，平均轮次从8.4降至3.9。 领域现状：企业IT支持交互本质上是诊断性的——用户提交模糊的症状报告…
tags:
  - "ACL 2026"
  - "信息检索/RAG"
  - "诊断式问答"
