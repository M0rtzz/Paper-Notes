...
description: >-
  [ACL 2025][AIGC检测][AI文本检测] 本文提出一种基于认知语言学特征的AI生成小说/虚构文本检测框架，通过建模人类创意写作中的认知模式（如叙事节奏、情感弧线、隐喻密度）来区分人类和AI创作的虚构文本，在长文本场景下显著优于现有检测方法。 领域现状：随着ChatGPT、Claude等大型语言模型的普及…
tags:
  - "ACL 2025"
  - "AIGC检测"
  - "AI文本检测"
