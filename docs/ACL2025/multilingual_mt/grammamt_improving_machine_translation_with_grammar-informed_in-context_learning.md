...
description: >-
  [ACL 2025][多语言/翻译][机器翻译] 提出 GrammaMT，利用语素间注释文本 (Interlinear Glossed Text, IGT) 的语法信息来增强 LLM 的 few-shot 机器翻译，在濒危语言上平均提升 12+ BLEU，在中高资源语言上也有一致改进。 领域现状： LLM 在高资源语言上的机…
tags:
  - "ACL 2025"
  - "多语言/翻译"
  - "机器翻译"
