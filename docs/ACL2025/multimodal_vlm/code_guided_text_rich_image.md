...
description: >-
  [ACL 2025][多模态VLM][合成数据] 提出CoSyn框架，利用纯文本LLM的代码生成能力自动创建40万张文本丰富图像（图表、文档、图表等）+270万条指令微调数据，训练的7B VLM在7个基准上达到SOTA，超越GPT-4V和Gemini 1.5 Flash。 领域现状：VLM在自然图像理解上表现优秀…
tags:
  - "ACL 2025"
  - "多模态VLM"
  - "合成数据"
