...
description: >-
  [ACL 2025][可解释性][ICD编码] 本文对 MDACE 数据集和当前可解释 ICD 编码系统进行了深入的应用导向分析，揭示了人工标注证据与代码描述的重叠规律、证据在文档中的分布特征，并提出了新的匹配度量来评估模型解释的实用性。 自动医疗编码是缓解文档和计费流程的关键技术。ICD（国际疾病分类）编码是医院场景中最重…
tags:
  - "ACL 2025"
  - "可解释性"
  - "ICD编码"
