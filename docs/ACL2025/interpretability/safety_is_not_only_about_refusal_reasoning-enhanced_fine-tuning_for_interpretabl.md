...
description: >-
  [ACL 2025][可解释性][LLM安全] 提出 Rational 框架，通过推理增强微调让 LLM 在回答前进行显式的安全推理（分析意图、伦理和潜在危害），而非依赖僵硬的拒绝启发式，在保持有用性的同时显著提升对推理层面对抗攻击的鲁棒性。 LLM 安全对齐面临的核心挑战在于：现有防御方法本质上都是"shallow ali…
tags:
  - "ACL 2025"
  - "可解释性"
  - "LLM安全"
