...
description: >-
  [ACL 2025][LLM 其他][function-calling] 提出 DICE-Bench，一个面向多轮多方对话场景的函数调用评测基准，包含 1607 条高质量对话实例和量化信息分散度的 DICE-Score 指标，揭示当前 LLM 在复杂对话中工具调用能力的不足。 - 现有问题：已有的函数调用基准（如 APIBe…
tags:
  - "ACL 2025"
  - "LLM 其他"
  - "function-calling"
