...
description: >-
  [ACL 2025][LLM 其他][test case generation] 本文提出TrickCatcher，利用LLM生成程序变体和测试输入生成器，结合diversity-driven差分测试来检测通过现有测试套件但仍含隐蔽bug的"plausible programs"，在Recall/Precision/F1上分别达到SOTA的1.80×/2.65×/1.66×。
tags:
  - "ACL 2025"
  - "LLM 其他"
