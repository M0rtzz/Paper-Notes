...
description: >-
  [ACL2025][LLM 其他][不确定性量化] 本文系统研究了长上下文 ICL 中增加示例数量对 LLM 预测不确定性的影响，通过不确定性分解揭示性能提升主要源于认知不确定性（EU）的降低，并从残差流投影角度解释了不确定性减少的内部机制。 长上下文 ICL 兴起：近年来长上下文技术（continued fine-tuni…
tags:
  - "ACL2025"
  - "LLM 其他"
  - "不确定性量化"
