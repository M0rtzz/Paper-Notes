...
description: >-
  [ACL 2025][LLM 其他][多目标对齐] 提出GAPO，一种基于梯度自适应缩放的多目标策略优化方法，利用多梯度下降算法(MGDA)结合梯度归一化，平衡LLM在帮助性和无害性等冲突目标间的权衡，并通过P-GAPO支持用户偏好驱动的Pareto前沿生成。 领域现状： RLHF是对齐LLM与人类偏好的主流方法…
tags:
  - "ACL 2025"
  - "LLM 其他"
  - "多目标对齐"
