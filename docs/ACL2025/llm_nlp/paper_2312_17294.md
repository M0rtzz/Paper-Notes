...
description: >-
  [ACL 2025 Main][LLM 其他][自主工具集成] 提出OpenAgent系统，通过Search→Setup→Apply→Store四阶段流程自主从GitHub搜索、配置、使用和存储仓库作为工具，解决LLM在金融、化学、生物等专业领域的开放域任务，平均成功率69.4%。 领域现状：LLM-based Agent通…
tags:
  - "ACL 2025 Main"
  - "LLM 其他"
  - "自主工具集成"
