...
description: >-
  [ACL 2025][LLM 其他][model mapping] 提出用对数似然向量（log-likelihood vector）将 1000+ 语言模型映射到一个统一空间，证明向量间欧氏距离近似 KL 散度，可实现模型聚类可视化、基准性能预测（r=0.96）和数据泄漏检测。 领域现状：LLM 生态爆发式增长…
tags:
  - "ACL 2025"
  - "LLM 其他"
  - "model mapping"
