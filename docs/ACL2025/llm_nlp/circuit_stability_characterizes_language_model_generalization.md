...
description: >-
  [ACL 2025][LLM 其他][电路稳定性] 本文提出"电路稳定性"作为评估语言模型泛化能力的新方法，通过数学形式化定义软电路和电路等价性，在算术推理、布尔表达式和体育理解三个案例研究中证明电路稳定性可以预测和刻画泛化行为。 评估语言模型的能力面临两大困难：(1) 现有基准测试快速饱和；(2) 创建更具挑战性的数据集需…
tags:
  - "ACL 2025"
  - "LLM 其他"
  - "电路稳定性"
