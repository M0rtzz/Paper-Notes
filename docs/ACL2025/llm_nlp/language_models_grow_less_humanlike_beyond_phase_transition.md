...
description: >-
  [ACL 2025][LLM 其他][预训练相变] 本文发现语言模型在预训练过程中与人类阅读行为的对齐（PPP）经历先升后降的拐点现象，通过关联和因果实验证明此拐点由预训练中的相变（specialized attention heads 的快速涌现）导致，且相变并非直接产生有害的注意力模式，而是改变了模型后续的学习动态使其持续偏离人类。
tags:
  - "ACL 2025"
  - "LLM 其他"
  - "预训练相变"
