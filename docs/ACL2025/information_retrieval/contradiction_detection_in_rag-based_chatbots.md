...
description: >-
  [ACL 2025][信息检索/RAG][矛盾检测] 本文针对 RAG 对话系统中检索文档与生成回答之间的矛盾问题，提出了一种多粒度矛盾检测框架，能够识别显式矛盾、隐式矛盾和部分矛盾，并提供可解释的矛盾定位。 领域现状：检索增强生成（RAG）已成为提升 LLM 事实准确性的主流方案，通过检索外部文档为生成提供事实基础…
tags:
  - "ACL 2025"
  - "信息检索/RAG"
  - "矛盾检测"
