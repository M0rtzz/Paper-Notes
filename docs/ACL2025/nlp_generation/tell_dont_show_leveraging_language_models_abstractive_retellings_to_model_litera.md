...
description: >-
  [ACL2025][文本生成][topic modeling] 提出 Retell 方法：利用小型 LM 对文学段落进行抽象复述（abstractive retelling）， 文学文本分析中的主题建模是文化分析（cultural analytics）的重要任务。 传统的词袋方法如 LDA 在处理文学文本时面临独特挑战： 文…
tags:
  - "ACL2025"
  - "文本生成"
  - "topic modeling"
