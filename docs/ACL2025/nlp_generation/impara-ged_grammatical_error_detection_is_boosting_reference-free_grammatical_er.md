...
description: >-
  [ACL 2025][文本生成][语法纠错评估] 在 IMPARA 的质量估计器构建之前，增加一步语法错误检测（GED）预训练，同时去掉失效的相似度估计器，使无参考 GEC 评估在 SEEDA 上达到句子级最高相关性。 语法纠错（GEC）系统需要可靠的自动评估方法来替代昂贵的人工评判。现有评估方法分为两类： - 有参考方法：…
tags:
  - "ACL 2025"
  - "文本生成"
  - "语法纠错评估"
