...
description: >-
  [ACL 2025][LLM对齐][指令微调] 通过系统性的 16 种超参数组合实验，揭示了指令微调数据质量评估中的严重问题——研究者对训练超参数的任意选择可以导致完全相反的「数据 A 优于数据 B」的结论，呼吁在报告数据质量时必须采用经过验证的超参数设置。 领域现状：指令微调（IT）是使 LLM 对齐用户意图的关键技术…
tags:
  - "ACL 2025"
  - "LLM对齐"
  - "指令微调"
