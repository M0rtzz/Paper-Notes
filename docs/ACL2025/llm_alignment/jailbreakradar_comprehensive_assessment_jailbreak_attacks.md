...
description: >-
  [ACL 2025][LLM对齐][越狱攻击] 首个覆盖自动和非自动越狱攻击的统一全面评估框架：收集17种代表性越狱攻击，建立六类攻击分类体系，在9个对齐LLM×8种防御策略下进行大规模系统评测，揭示启发式攻击"高ASR但低实用性"的关键洞察。 领域现状： LLM安全对齐是当前AI安全的核心课题，但各种越狱攻击方法不断涌现试…
tags:
  - "ACL 2025"
  - "LLM对齐"
  - "越狱攻击"
