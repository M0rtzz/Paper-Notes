...
description: >-
  [ACL 2025][对话系统][目标导向对话] 提出模型无关的两阶段 CRC 框架（一致性反思 + 一致性纠正），通过先让模型反思生成回复与对话上下文之间的不一致之处、再据此纠正回复，显著提升了目标导向主动对话系统中生成回复与对话上下文的一致性。 领域现状：目标导向的主动对话系统旨在引导用户对话无缝地走向特定目标…
tags:
  - "ACL 2025"
  - "对话系统"
  - "目标导向对话"
