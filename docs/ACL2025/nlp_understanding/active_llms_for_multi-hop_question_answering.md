...
description: >-
  [ACL 2025][NLP理解][多跳问答] 本文提出一种主动式大语言模型框架，通过让LLM主动决定何时需要检索外部信息、何时可以直接推理，从而在多跳问答任务中实现更高效、更准确的推理过程。 领域现状：多跳问答（Multi-hop QA）要求模型跨越多个文档或知识片段进行推理，目前主流方法包括检索增强生成（RAG）和链式思…
tags:
  - "ACL 2025"
  - "NLP理解"
  - "多跳问答"
