...
description: >-
  [ACL 2025][NLP理解][共指消解] 提出首个书级别共指消解基准BookCoref，通过角色链接+LLM过滤+窗口扩展的自动标注管线，在50本完整小说上生成高质量银标注数据，平均文档长度超过20万tokens。 领域现状： 共指消解系统通常在短/中等长度文档上评估（OntoNotes平均467 tokens…
tags:
  - "ACL 2025"
  - "NLP理解"
  - "共指消解"
