---
title: >-
  ACL2025 幻觉检测论文汇总 · 28篇论文解读
description: >-
  28篇ACL2025的幻觉检测方向论文解读，涵盖 LLM、多模态、RAG、对齐/RLHF等方向。覆盖该方向前沿研究进展与技术创新，每篇含一句话总结、核心思想、方法详解、实验结果与局限性分析，5分钟读懂一篇论文核心思想，助你快速跟进AI领域最新研究动态、学术前沿趋势与核心技术突破。
tags:
  - "ACL2025"
  - "幻觉检测"
  - "论文解读"
  ...
  - "对齐/RLHF"
item_list:
  - u: "activation_steering_decoding_mitigating_hallucination_in_large_vision-language_m/"
  ...
  - u: "fiha_autonomous_hallucination_evaluation_in_vision-language_models_with_davidson/"
    t: "FIHA: Autonomous Fine-grained Hallucination Evaluation in Vision-Language Models with Davidson Scene Graphs"
  - u: "hallucination_detox_send/"
    t: "Hallucination Detox: Sensitivity Dropout (SenD) for Large Language Model Training"
  - u: "hallulens_llm_hallucination_benchmark/"
  ...
  - u: "intent_hallucination_eval/"
    t: "Beyond Facts: Evaluating Intent Hallucination in Large Language Models"
  - u: "learning_auxiliary_tasks_improves_reference-free_hallucination_detection_in_open/"
    t: "Learning Auxiliary Tasks Improves Reference-Free Hallucination Detection in Open-Domain Long-Form Generation"
  - u: "localizing_and_mitigating_errors_in_long-form_question_answering/"
    t: "Fine-grained Hallucination Detection and Mitigation in Long-form Question Answering"
  - u: "mixture_of_decoding_an_attention-inspired_adaptive_decoding_strategy_to_mitigate/"
    t: "Mixture of Decoding: An Attention-Inspired Adaptive Decoding Strategy to Mitigate Hallucination in Multimodal LLMs"
  - u: "monitoring_decoding_mitigating_hallucination_via_evaluating_the_factuality_of_pa/"
    t: "Monitoring Decoding: Mitigating Hallucination via Evaluating the Factuality of Partial Response during Generation"
  - u: "on-policy_self-alignment_with_fine-grained_knowledge_feedback_for_hallucination_/"
    t: "On-Policy Self-Alignment with Fine-grained Knowledge Feedback for Hallucination Mitigation"
  - u: "reefknot_a_comprehensive_benchmark_for_relation_hallucination_evaluation_analysi/"
    t: "ReefKnot: A Comprehensive Benchmark for Relation Hallucination Evaluation, Analysis and Mitigation in Multimodal Large Language Models"
  - u: "refind_at_semeval-2025_task_3_retrieval-augmented_factuality_hallucination_detec/"
    t: "REFIND at SemEval-2025 Task 3: Retrieval-Augmented Factuality Hallucination Detection in Large Language Models"
  - u: "removal_of_hallucination_on_hallucination_debate-augmented_rag/"
    t: "Removal of Hallucination on Hallucination: Debate-Augmented RAG"
  - u: "retrieval_visual_contrastive_decoding_to_mitigate_object_hallucinations_in_large/"
    t: "Retrieval Visual Contrastive Decoding to Mitigate Object Hallucinations in Large Vision-Language Models"
  - u: "stochastic_chameleons_irrelevant_context_hallucinations_reveal_class-based_misge/"
    t: "Stochastic Chameleons: Irrelevant Context Hallucinations Reveal Class-Based (Mis)Generalization in LLMs"
  - u: "treecut_a_synthetic_unanswerable_math_word_problem_dataset_for_llm_hallucination/"
    t: "TreeCut: A Synthetic Unanswerable Math Word Problem Dataset for LLM Hallucination Evaluation"
  - u: "visual_evidence_prompting/"
...
📌 **同领域跨会议浏览：** [🧪 ICML2026 (19)](../../ICML2026/hallucination/index.md) · [💬 ACL2026 (27)](../../ACL2026/hallucination/index.md) · [📷 CVPR2026 (19)](../../CVPR2026/hallucination/index.md) · [🔬 ICLR2026 (9)](../../ICLR2026/hallucination/index.md) · [🤖 AAAI2026 (15)](../../AAAI2026/hallucination/index.md) · [🧠 NeurIPS2025 (17)](../../NeurIPS2025/hallucination/index.md)
