...
description: >-
  [ACL 2025][LLM推理][Chain-of-Thought] 系统研究影响 CoT 蒸馏的三大因素（粒度、格式、教师模型），发现 SLM 与粒度呈非单调关系、格式影响较小、强教师不总是更好。 领域现状：CoT prompting 大幅提升 LLM 推理能力，但计算开销大，需将 CoT 能力蒸馏到小模型…
tags:
  - "ACL 2025"
  - "LLM推理"
  - "Chain-of-Thought"
