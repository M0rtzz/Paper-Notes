...
description: >-
  [ACL 2025][知识编辑][脚本生成] 提出 ScEdit，一个基于脚本（Script）的知识编辑评估基准，将传统的"What"类事实回忆评估扩展为"How"类程序性推理评估，同时引入 token 级和文本级双层评估体系，揭示了现有知识编辑方法在实际应用场景中的显著不足。 知识编辑（KE）领域近年来发展迅速…
tags:
  - "ACL 2025"
  - "知识编辑"
  - "脚本生成"
