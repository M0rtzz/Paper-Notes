...
description: >-
  [ACL 2025][社会计算][misinformation] 构建了目前最大的误信息评估基准 MisBench（1034 万条误信息），从知识冲突类型和文本风格两个维度系统分析 LLM 对误信息的行为和偏好，并提出 RtD 方法结合外部知识源提升误信息检测能力。 领域现状：LLM 在知识密集型任务上表现出色…
tags:
  - "ACL 2025"
  - "社会计算"
  - "misinformation"
