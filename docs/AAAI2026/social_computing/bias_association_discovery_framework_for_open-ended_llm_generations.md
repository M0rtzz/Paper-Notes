...
description: >-
  [AAAI 2026][社会计算][社会偏见] 提出偏见关联发现框架 BADF，通过分析 LLM 开放式故事生成中的叙事内容，系统性地提取人口统计身份与描述性概念之间的已知和未知偏见关联，突破了以往依赖预定义偏见概念的局限。 领域现状：LLM 在大规模真实数据上训练后，不可避免地编码了社会偏见，导致对不同人口群体产生不公平的…
tags:
  - "AAAI 2026"
  - "社会计算"
  - "社会偏见"
