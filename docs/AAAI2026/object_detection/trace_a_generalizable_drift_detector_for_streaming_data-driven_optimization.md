...
description: >-
  [AAAI 2026][目标检测][概念漂移检测] 提出TRACE，一种基于注意力序列学习的可迁移概念漂移检测器，通过统计特征标记化和双注意力编码器学习跨任务可迁移的漂移模式，能泛化到未见过的数据集，并作为即插即用模块嵌入流式数据驱动优化算法。
tags:
  - AAAI 2026
  - 目标检测
  - 概念漂移检测
...
- [\[CVPR 2026\] Drift-Resilient Temporal Priors for Visual Tracking](../../CVPR2026/object_detection/drift-resilient_temporal_priors_for_visual_tracking.md)
