...
- [A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision](../../ICCV2025/3d_vision/a_lesson_in_splats_teacherguided_diffusion_for_3d_gaussian_s.md)
- [Using Gaussian Splats to Create High-Fidelity Facial Geometry and Texture](../../CVPR2026/3d_vision/using_gaussian_splats_to_create_high-fidelity_facial_geometry_and_texture.md)
...
- [SplatFields: Neural Gaussian Splats for Sparse 3D and 4D Reconstruction](../../ECCV2024/3d_vision/splatfields_neural_gaussian_splats_for_sparse_3d_and_4d_reconstruction.md)
