...
- [ZPressor: Bottleneck-Aware Compression for Scalable Feed-Forward 3DGS](../../NeurIPS2025/3d_vision/zpressor_bottleneck-aware_compression_for_scalable_feed-forward_3dgs.md)
- [Toward Generalizable Whole Brain Representations with High-Resolution Light-Sheet Data](../../CVPR2026/3d_vision/toward_generalizable_whole_brain_representations_with_high-resolution_light-shee.md)
