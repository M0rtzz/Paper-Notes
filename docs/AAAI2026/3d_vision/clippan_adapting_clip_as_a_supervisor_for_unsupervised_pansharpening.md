...
description: >-
  [AAAI 2026][3D视觉][全色锐化] 提出 CLIPPan，通过轻量微调 CLIP 使其理解多光谱/全色/高分辨率多光谱图像类型及全色锐化过程，然后利用 Wald 协议等文本提示作为语义监督信号，实现无需地面真值的全分辨率无监督全色锐化，可作为即插即用模块兼容任意全色锐化骨干网络。
tags:
  - "AAAI 2026"
  - "3D视觉"
  - "全色锐化"
...
- [\[CVPR 2025\] Targeted Forgetting of Image Subgroups in CLIP Models](../../CVPR2025/3d_vision/targeted_forgetting_of_image_subgroups_in_clip_models.md)
