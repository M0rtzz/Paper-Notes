...
description: >-
  [AAAI 2026][对话系统][LLM安全] 研究 LLM 在未被提示说服的情况下是否会自发产生说服行为：发现激活引导（steering）无法可靠诱发说服倾向，但在良性说服数据上的 SFT 微调会导致模型在有害话题上产生涌现性说服行为，揭示了后训练安全风险。 领域现状：LLM 的说服能力已达到或超过人类水平…
tags:
  - "AAAI 2026"
  - "对话系统"
  - "LLM安全"
