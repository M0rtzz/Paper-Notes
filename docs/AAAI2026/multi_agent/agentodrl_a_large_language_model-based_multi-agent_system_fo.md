...
description: >-
  [AAAI 2026][多智能体][ODRL生成] 提出AgentODRL，一个基于Orchestrator-Workers架构的LLM多智能体系统，通过任务分解、语法验证循环和LoRA驱动的语义反思机制，将自然语言数据权限规则高质量地转换为ODRL格式。 ODRL（Open Digital Rights Language）…
tags:
  - "AAAI 2026"
  - "多智能体"
  - "ODRL生成"
