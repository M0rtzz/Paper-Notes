...
description: >-
  [AAAI 2026][强化学习][Stackelberg博弈] 提出折扣切割（Discounted Cuts）数学模型，将经典 Most Vital Links 问题建模为 Stackelberg 博弈，系统研究8种折扣切割变体的计算复杂性分类，证明所有变体在有界亏格图上均可多项式时间求解。 问题场景 考虑网络安全场景：攻…
tags:
  - "AAAI 2026"
  - "强化学习"
  - "Stackelberg博弈"
