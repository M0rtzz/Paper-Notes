...
description: >-
  [AAAI 2026][强化学习][测试时对齐] 提出一种测试时策略塑形方法，通过轻量级伦理属性分类器在推理阶段插值修改预训练 RL 智能体的动作概率分布，无需重训练即可实现对多种伦理属性的细粒度行为引导。 - 以最大化奖励为目标训练的 RL 智能体会表现出马基雅维利式行为（权力寻求、伦理违规等），与人类价值观不一致 - 现…
tags:
  - "AAAI 2026"
  - "强化学习"
  - "测试时对齐"
