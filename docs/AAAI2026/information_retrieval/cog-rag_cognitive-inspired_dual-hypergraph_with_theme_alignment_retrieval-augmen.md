...
description: >-
  [AAAI 2026][信息检索/RAG][超图] 提出 Cog-RAG，用主题超图和实体超图构建双超图索引，模拟人类"自顶向下"的认知过程进行两阶段检索（先主题后细节），实现从全局语义到局部信息的对齐生成。 领域现状：RAG 通过引入外部知识缓解 LLM 幻觉问题，已在问答、文档理解等任务广泛应用。当前方法多采用扁平的 c…
tags:
  - "AAAI 2026"
  - "信息检索/RAG"
  - "超图"
