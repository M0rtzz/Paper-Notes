...
description: >-
  [CVPR 2025][人体理解][GUI理解] MP-GUI设计了三个专用感知器分别提取GUI中的图形、文本和空间模态信息，通过空间结构精炼策略和自适应融合门控将三种模态组合，在有限训练数据下在多种GUI理解任务上取得了优于通用MLLM的表现。
tags:
  - CVPR 2025
  - 人体理解
  - GUI理解
...
**代码**: https://github.com/BigTaige/MP-GUI (有)  
**领域**: 人机交互 / 多模态VLM  
