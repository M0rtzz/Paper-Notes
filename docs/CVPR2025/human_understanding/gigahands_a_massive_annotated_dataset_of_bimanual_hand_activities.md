...
description: "提出GigaHands大规模双手活动数据集，包含34小时、1.83亿帧、84K文本标注，通过程序化采集策略实现活动多样性和高效标注"
tags: ["手部理解", "数据集", "动作生成", "双手交互", "CVPR2025"]
---
...
**代码**: https://ivl.cs.brown.edu/research/gigahands.html  
**领域**: 人体理解  
...
- [HandX: Scaling Bimanual Motion and Interaction Generation](../../CVPR2026/human_understanding/handx_scaling_bimanual_motion_and_interaction_generation.md)
