...
description: >-
  [CVPR 2025][Human Understanding][Mobile Agent] 提出 MONDAY 数据集生成框架，从 YouTube 教学视频自动构建大规模移动端导航数据集（20K 视频、313K 标注帧），通过 OCR 场景转换检测 + 3 步动作识别流程实现 $0.34/视频的低成本标注。在 MONDAY 上预训练的 agent 在未见 Windows Mobile 平台上平均提升 18.11%。
tags:
  - CVPR 2025
  - Human Understanding
  - Mobile Agent
...
- [GUIOdyssey: A Comprehensive Dataset for Cross-App GUI Navigation on Mobile Devices](../../ICCV2025/human_understanding/guiodyssey_a_comprehensive_dataset_for_cross-app_gui_navigation_on_mobile_device.md)
