...
description: >-
  [CVPR 2025][人体理解][大气湍流消除] 提出 MambaTM——首个基于 Mamba 的视频大气湍流消除网络，通过 VAE 将传统 Zernike 多项式表示的相位畸变重参数化为潜在相位畸变（LPD），用 LPD 引导 SSM 的状态转移；在保持线性复杂度和全局感受野的同时，实现了 SOTA 恢复质量和接近 2× 的推理加速（55.4 FPS vs 32.7 FPS）。
tags:
  - CVPR 2025
  - 人体理解
  - 大气湍流消除
...
**代码**: https://xg416.github.io/MambaTM  
**领域**: 图像/视频恢复 / 大气湍流消除  
