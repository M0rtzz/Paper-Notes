...
description: >-
  [CVPR 2025][人体理解][动作生成] 提出 StickMotion 框架，通过用户手绘的火柴人图作为细粒度动作控制条件，结合文本描述实现全局+局部的 3D 人体动作生成，并设计多条件模块（MCM）高效处理条件组合，节省用户 51.5% 的动作创意表达时间。 文本到动作生成虽然取得显著进展，但简单的文本描述（如"向前…
tags:
  - "CVPR 2025"
  - "人体理解"
  - "动作生成"
