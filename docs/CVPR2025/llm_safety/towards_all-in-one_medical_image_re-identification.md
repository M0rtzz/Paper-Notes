...
description: >-
  [CVPR 2025][LLM安全][医学图像重识别] 提出 MaMI，首个全模态统一的医学图像重识别模型，通过连续模态参数适配器 (ComPA) 动态生成模态特定参数，并利用医学基础模型的差异特征对齐传递医学先验，在 11 个数据集上超越 25 个基础模型和 8 个大语言模型。 医学图像重识别（MedReID）在个性化医疗…
tags:
  - "CVPR 2025"
  - "LLM安全"
  - "医学图像重识别"
