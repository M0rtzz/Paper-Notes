...
description: >-
  [CVPR 2025][模型压缩][压缩视频增强] 本文提出一种编解码器感知的压缩视频增强框架，通过复用码流中的压缩因子、运动向量和分区图等信息，以单一模型自适应增强不同压缩级别的视频，同时作为即插即用模块辅助多种下游视觉任务。 领域现状：视频压缩是数据传输中的标准操作，然而压缩不可避免地引入伪影降低视觉质量…
tags:
  - "CVPR 2025"
  - "模型压缩"
  - "压缩视频增强"
