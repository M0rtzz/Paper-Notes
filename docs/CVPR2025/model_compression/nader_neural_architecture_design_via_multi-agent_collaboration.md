...
description: >-
  [CVPR 2025][Model Compression][Multi-Agent NAS] 提出 NADER 框架，用多 LLM Agent 协作（阅读论文→提出方案→修改架构→反思改进）进行神经架构设计，通过 DAG 图表示 + 设计经验数据库，仅 10 次试验即超越 NAS-Bench-201 搜索空间最优，CIFAR-100 精度 74.51% vs 73.51%。
tags:
  - CVPR 2025
  - Model Compression
  - Multi-Agent NAS
