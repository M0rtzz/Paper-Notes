---
title: >-
  [论文解读] The Change You Want To Detect: Semantic Change Detection In Earth Observation With Hybrid Models
description: >-
  [CVPR 2025][遥感变化检测] 提出HySCDG混合数据生成流水线，结合真实VHR影像与inpainting生成大规模语义变化检测数据集，实现简洁高效的变化检测基线
tags:
  - CVPR 2025
  - 遥感
  - 变化检测
