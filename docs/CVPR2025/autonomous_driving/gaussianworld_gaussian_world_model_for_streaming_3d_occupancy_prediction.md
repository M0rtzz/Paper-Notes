...
description: "基于高斯世界模型的流式3D占用预测框架，将场景演化分解为自车运动对齐、动态物体运动和新观测区域补全三个因素"
tags: ["3D占用预测", "世界模型", "3D高斯", "自动驾驶", "时序建模"]
---
...
- [AGO: Adaptive Grounding for Open World 3D Occupancy Prediction](../../ICCV2025/autonomous_driving/ago_adaptive_grounding_for_open_world_3d_occupancy_predictio.md)
