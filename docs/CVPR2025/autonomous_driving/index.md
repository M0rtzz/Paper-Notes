---
title: >-
  CVPR2025 自动驾驶论文汇总 · 89篇论文解读
description: >-
  89篇CVPR2025的自动驾驶方向论文解读，涵盖自动驾驶、3D 目标检测、扩散模型、3D 高斯渲染、点云、语义分割等方向。覆盖该方向前沿研究进展与技术创新，每篇含一句话总结、核心思想、方法详解、实验结果与局限性分析，5分钟读懂一篇论文核心思想。
tags:
  - "CVPR2025"
  - "自动驾驶"
  - "论文解读"
  ...
  - "语义分割"
item_list:
  - u: "3d-avs_lidar-based_3d_auto-vocabulary_segmentation/"
    t: "3D-AVS: LiDAR-based 3D Auto-Vocabulary Segmentation"
  - u: "3d_occupancy_prediction_with_low-resolution_queries_via_prototype-aware_view_tra/"
    t: "ProtoOcc: 3D Occupancy Prediction with Low-Resolution Queries via Prototype-aware View Transformation"
  - u: "a_dataset_for_semantic_segmentation_in_the_presence_of_unknowns/"
    t: "A Dataset for Semantic Segmentation in the Presence of Unknowns"
  - u: "a_neuro-symbolic_framework_combining_inductive_and_deductive_reasoning_for_auton/"
    t: "A Neuro-Symbolic Framework Combining Inductive and Deductive Reasoning for Autonomous Driving Planning"
  - u: "a_prediction-as-perception_framework_for_3d_object_detection/"
    t: "PAP: A Prediction-as-Perception Framework for 3D Object Detection"
  - u: "cawm-mamba_a_unified_model_for_infrared-visible_image_fusion_and_compound_advers/"
    t: "CAWM-Mamba: A Unified Model for Infrared-Visible Image Fusion and Compound Adverse Weather Restoration"
  - u: "certified_human_trajectory_prediction/"
    t: "Certified Human Trajectory Prediction"
  - u: "climbingcap_multi-modal_dataset_and_method_for_rock_climbing_in_world_/"
    t: "ClimbingCap: Multi-Modal Dataset and Method for Rock Climbing in World Coordinate"
  - u: "closed-loop_supervised_fine-tuning_of_tokenized_traffic_models/"
    t: "Closed-Loop Supervised Fine-Tuning of Tokenized Traffic Models"
  - u: "composing_driving_worlds_through_disentangled_control_for_adversarial_scenario_g/"
    t: "CompoSIA: Composing Driving Worlds through Disentangled Control for Adversarial Scenario Generation"
  - u: "cubify_anything_scaling_indoor_3d_object_detection/"
    t: "Cubify Anything: Scaling Indoor 3D Object Detection"
  - u: "decoupledgaussian_object-scene_decoupling_for_physics-based_interaction/"
    t: "DecoupledGaussian: Object-Scene Decoupling for Physics-Based Interaction"
  - u: "diffusiondrive_truncated_diffusion_model_for_end-to-end_autonomous_driving/"
    t: "DiffusionDrive: Truncated Diffusion Model for End-to-End Autonomous Driving"
  - u: "distilling_monocular_foundation_model_for_fine-grained_depth_completion/"
    t: "Distilling Monocular Foundation Model for Fine-grained Depth Completion"
  - u: "distilling_multi-modal_large_language_models_for_autonomous_driving/"
    t: "Distilling Multi-modal Large Language Models for Autonomous Driving"
  - u: "driving_by_the_rules_a_benchmark_for_integrating_traffic_sign_regulations_into_v/"
    t: "Driving by the Rules: A Benchmark for Integrating Traffic Sign Regulations into Vectorized HD Map"
  - u: "drivingsphere_building_a_high-fidelity_4d_world_for_closed-loop_simulation/"
    t: "DrivingSphere: Building a High-fidelity 4D World for Closed-loop Simulation"
  - u: "ev-3dod_pushing_the_temporal_boundaries_of_3d_object_detection_with_event_camera/"
    t: "EV-3DOD: Pushing the Temporal Boundaries of 3D Object Detection with Event Cameras"
  - u: "evolsplat_efficient_volume-based_gaussian_splatting_for_urban_view_synthesis/"
    t: "EVolSplat: Efficient Volume-based Gaussian Splatting for Urban View Synthesis"
  - u: "exploring_scene_affinity_for_semi-supervised_lidar_semantic_segmentation/"
    t: "Exploring Scene Affinity for Semi-Supervised LiDAR Semantic Segmentation"
  - u: "forestlpr_lidar_place_recognition_in_forests_attentioning_multiple_bev_density_i/"
    t: "ForestLPR: LiDAR Place Recognition in Forests Attentioning Multiple BEV Density Images"
  - u: "freesim_toward_free-viewpoint_camera_simulation_in_driving_scenes/"
    t: "FreeSim: Toward Free-Viewpoint Camera Simulation in Driving Scenes"
  - u: "gaussianformer-2_probabilistic_gaussian_superposition_for_efficient_3d_occupancy/"
    t: "GaussianFormer-2: Probabilistic Gaussian Superposition for Efficient 3D Occupancy Prediction"
  - u: "gaussianworld_gaussian_world_model_for_streaming_3d_occupancy_prediction/"
    t: "GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction"
  - u: "gdfusion_temporal_fusion_occupancy/"
    t: "GDFusion: Rethinking Temporal Fusion with a Unified Gradient Descent View for 3D Semantic Occupancy Prediction"
  - u: "generating_multimodal_driving_scenes_via_next-scene_prediction/"
    t: "Generating Multimodal Driving Scenes via Next-Scene Prediction"
  - u: "generative_gaussian_splatting_for_unbounded_3d_city_generation/"
    t: "Generative Gaussian Splatting for Unbounded 3D City Generation"
  - u: "glane3d_detecting_lanes_with_graph_of_3d_keypoints/"
    t: "GLane3D: Detecting Lanes with Graph of 3D Keypoints"
  - u: "interactionmap_improving_online_vectorized_hdmap_construction_with_interaction/"
    t: "InteractionMap: Improving Online Vectorized HDMap Construction with Interaction"
  - u: "learning_to_detect_objects_from_multi-agent_lidar_scans_without_manual_labels/"
    t: "Learning to Detect Objects from Multi-Agent LiDAR Scans without Manual Labels"
item_total: 89
---
...
📌 **同领域跨会议浏览：** [🧪 ICML2026 (6)](../../ICML2026/autonomous_driving/index.md) · [📷 CVPR2026 (118)](../../CVPR2026/autonomous_driving/index.md) · [🔬 ICLR2026 (16)](../../ICLR2026/autonomous_driving/index.md) · [🤖 AAAI2026 (56)](../../AAAI2026/autonomous_driving/index.md) · [🧠 NeurIPS2025 (47)](../../NeurIPS2025/autonomous_driving/index.md) · [📹 ICCV2025 (91)](../../ICCV2025/autonomous_driving/index.md)
