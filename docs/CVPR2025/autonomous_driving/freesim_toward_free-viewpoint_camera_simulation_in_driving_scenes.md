...
description: >-
  [CVPR 2025][自动驾驶][自由视角仿真] 本文提出FreeSim，通过将挑战性的偏离轨迹新视角生成问题重新表述为生成式图像增强问题，配合piece-wise高斯重建的训练数据构造和渐进式视角扩展策略，首次实现了驾驶场景中超过3米横向偏移的高质量自由视角渲染。 领域现状 逼真的驾驶仿真是自动驾驶开发的基础组件…
tags:
  - "CVPR 2025"
  - "自动驾驶"
  - "自由视角仿真"
