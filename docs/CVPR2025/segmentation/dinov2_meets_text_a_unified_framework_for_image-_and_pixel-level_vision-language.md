...
description: >-
  [CVPR 2025][图像分割][视觉语言对齐] dino.txt 通过 Locked-image Text Tuning 策略将冻结的 DINOv2 视觉编码器与从头训练的文本编码器对齐，利用 CLS+平均池化拼接表征和文本+图像双模态数据平衡策略，以极低训练成本实现零样本分类和开放词汇分割的 SOTA 性能。
tags:
  - CVPR 2025
  - 图像分割
  - 视觉语言对齐
