...
description: "提出FRACAL后校准方法，利用分形维数捕获类别-位置依赖关系，在推理时结合频率和空间信息校准长尾目标检测"
tags: ["long-tailed detection", "post-calibration", "fractal dimension", "logit adjustment", "CVPR2025"]
---
