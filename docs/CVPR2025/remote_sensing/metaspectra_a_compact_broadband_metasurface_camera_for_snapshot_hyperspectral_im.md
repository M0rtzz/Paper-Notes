...
description: >-
  [CVPR2025][遥感][超表面] 提出 MetaSpectra+，一种基于超表面-折射混合光学的紧凑多功能相机，通过双层超表面独立控制各通道色散/曝光/偏振，在约 250nm 可见光带宽内实现快照式高光谱+HDR 或高光谱+偏振联合成像，重建精度在基准数据集上达到 SOTA。 领域现状 领域现状：多功能超表面成像可在紧…
tags:
  - "CVPR2025"
  - "遥感"
  - "超表面"
