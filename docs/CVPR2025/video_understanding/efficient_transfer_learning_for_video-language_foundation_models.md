...
description: >-
  [CVPR 2025][视频理解][参数高效微调] 提出多模态时空适配器MSTA，通过视觉-语言共享投影层和时空描述引导的一致性约束，以仅2-7%的可训练参数实现视频-语言基础模型向下游任务的高效迁移。 预训练的视频-语言基础模型（如CLIP、ViCLIP）在下游视频任务上需要适配。现有方法面临两个核心矛盾： 1. 参数量与…
tags:
  - "CVPR 2025"
  - "视频理解"
  - "参数高效微调"
