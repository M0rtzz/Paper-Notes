...
description: "提出DivPrune，将视觉token剪枝形式化为Max-Min多样性问题(MMDP)，通过最大化保留token间的最小距离来减少冗余，无需训练或校准即可即插即用，在16个图像/视频数据集上实现SOTA剪枝性能，尤其在高剪枝率下优势显著。"
tags: ["视觉token剪枝", "LMM效率", "多样性优化", "MMDP", "即插即用"]
---
