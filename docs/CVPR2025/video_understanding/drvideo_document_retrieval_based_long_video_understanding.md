...
description: "提出DrVideo，将长视频理解转化为长文档检索与理解任务，通过视频-文档转换、文档检索、文档增强和多阶段Agent交互循环逐步获取问题相关信息，在EgoSchema、MovieChat-1K和Video-MME上大幅超越现有LLM-based方法。"
tags: ["长视频理解", "文档检索", "LLM Agent", "零样本", "信息增强"]
---
