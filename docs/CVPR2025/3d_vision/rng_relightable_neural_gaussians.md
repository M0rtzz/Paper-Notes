...
description: >-
  [CVPR 2025][3D视觉][3D高斯溅射] 提出可重光照神经高斯 (RNG) 框架，通过学习每个高斯点的潜向量并以视角和光照方向为条件，结合阴影线索和混合前向-延迟优化策略，实现软边界物体的高质量重光照。 创建可重光照的3D资产对内容创作至关重要，但光照、几何和材质的分解本质上是病态问题。现有方法大多依赖解析着色模型…
tags:
  - "CVPR 2025"
  - "3D视觉"
  - "3D高斯溅射"
