...
description: >-
  [CVPR 2025][3D视觉][多视图扩散] 本文提出 See3D，一个在大规模互联网视频（320M 帧/16M 视频片段）上训练的无位姿视觉条件多视图扩散模型，通过自动化数据筛选管线和时间依赖的视觉条件设计，实现了零样本开放世界 3D 生成能力。 - 3D 数据的稀缺性：现有 3D 生成模型依赖昂贵的 3D "金标签"…
tags:
  - "CVPR 2025"
  - "3D视觉"
  - "多视图扩散"
