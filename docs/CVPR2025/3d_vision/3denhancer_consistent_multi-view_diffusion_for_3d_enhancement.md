...
description: >-
  [CVPR 2025][3D视觉][多视图扩散] 提出一个基于多视图潜在扩散模型的3D增强框架，通过姿态感知编码器、多视图行注意力和近视图极线聚合模块，在保持跨视图一致性的前提下显著提升低质量3D生成结果的纹理质量。 领域现状：当前3D生成主流采用两阶段管线——先用多视图扩散模型生成多角度图像（如MVDream）…
tags:
  - "CVPR 2025"
  - "3D视觉"
  - "多视图扩散"
