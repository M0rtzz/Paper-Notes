...
description: "提出ASTRA防御框架，通过图像归因构建转向向量并进行自适应激活转向，高效防御VLM越狱攻击，在多个模型上实现SOTA防御效果且推理开销几乎为零"
tags: ["VLM安全", "越狱防御", "激活转向", "对抗鲁棒性", "推理时防御"]
---
...
**代码**: https://github.com/ASTRAL-Group/ASTRA (有)  
**领域**: 多模态VLM  
