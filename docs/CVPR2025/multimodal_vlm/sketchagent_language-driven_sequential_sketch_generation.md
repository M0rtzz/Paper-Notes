...
description: >-
  [CVPR 2025][Multimodal VLM][Sketch Generation] 提出 SketchAgent，一种零训练的语言驱动草图生成方法——通过网格画布+贝塞尔曲线拟合+上下文学习，让预训练多模态 LLM（Claude 3.5-Sonnet）以逐笔画方式生成接近人类水平的草图，并支持协作绘图和对话式编辑。
tags:
  - CVPR 2025
  - Multimodal VLM
  - Sketch Generation
