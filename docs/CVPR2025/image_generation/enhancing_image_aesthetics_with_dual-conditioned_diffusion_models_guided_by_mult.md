...
description: >-
  [CVPR 2025][图像生成][图像美学增强] 提出 DIAE，通过多模态美学感知模块（MAP）将模糊美学指令转化为 HSV/轮廓图+文本的多模态控制信号，并构建"非完美配对"数据集 IIAEData 配合双分支监督策略实现弱监督美学增强，在 LAION 和 MLLM 美学评分上达 SOTA。 领域现状：图像美学增强（I…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "图像美学增强"
