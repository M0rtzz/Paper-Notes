...
- [Circuit Mechanisms for Spatial Relation Generation in Diffusion Transformers](../../CVPR2026/image_generation/circuit_mechanisms_for_spatial_relation_generation_in_diffusion_transformers.md)
