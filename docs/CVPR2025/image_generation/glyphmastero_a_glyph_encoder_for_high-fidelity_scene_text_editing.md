...
description: >-
  [CVPR 2025][图像生成][场景文字编辑] 提出GlyphMastero字形编码器，通过双流（局部字符级+全局文本行级）特征提取、跨层次注意力交互和多尺度FPN融合，为扩散模型提供笔画级精确的字形引导，在多语言场景文字编辑中句子准确率提升18.02%、FID降低53.28%。 1. 领域现状：场景文字编辑要求在保持原…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "场景文字编辑"
