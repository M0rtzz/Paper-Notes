...
description: >-
  [CVPR 2025][图像生成][多视图生成] Pippo提出了一种多视图扩散Transformer，从单张随手拍照片生成1K分辨率的人体环绕视频，通过三阶段训练策略（预训练30亿人体图像+中训+后训）和推理时注意力偏置技术，实现超过训练视图数5倍的生成能力。 领域现状 领域现状：从单张图像生成人体的多视图一致表示在娱乐、…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "多视图生成"
