...
description: "增强扩散模型用于高质量大运动视频帧插值，通过Transformer tokenizer、时序注意力和帧差嵌入三重增强提升扩散过程的影响力"
tags: ["视频帧插值", "扩散模型", "DiT", "大运动", "图像生成"]
---
...
- [DreamMover: Leveraging the Prior of Diffusion Models for Image Interpolation with Large Motion](../../ECCV2024/image_generation/dreammover_leveraging_the_prior_of_diffusion_models_for_image_interpolation_with.md)
- [EMDM: Efficient Motion Diffusion Model for Fast and High-Quality Motion Generation](../../ECCV2024/image_generation/emdm_efficient_motion_diffusion_model_for_fast_and_high-quality_motion_generatio.md)
