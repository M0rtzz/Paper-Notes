...
description: >-
  [CVPR 2025][图像生成][概念擦除] 本文揭示了扩散模型中概念擦除方法的根本缺陷——通过扩散反演找到高似然度的潜变量种子，证明被擦除的概念信息仍然存留在模型中，且可以从多个不同的种子向量重建出被擦除概念的高质量图像。 1. 领域现状：扩散模型在文本到图像生成领域占据主导地位，但可能生成不安全内容（暴力、色情）或侵犯…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "概念擦除"
