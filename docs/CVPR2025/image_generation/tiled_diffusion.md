...
description: >-
  [CVPR 2025][图像生成][图像拼贴] 提出 Tiled Diffusion，通过在扩散模型的潜空间中引入拼贴约束和相似性约束，首次支持从自拼贴到复杂多对多连接的多种拼贴场景，实现无缝且连贯的可拼贴图像生成。 图像拼贴——将不同图像无缝连接以创建连贯视觉场景——在纹理创建、游戏资产开发和数字艺术中至关重要…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "图像拼贴"
