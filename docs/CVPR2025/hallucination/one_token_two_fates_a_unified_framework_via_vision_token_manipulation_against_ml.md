...
description: >-
  [CVPR 2025][幻觉检测][MLLM幻觉] 提出首个统一的训练无关MLLM幻觉缓解框架，围绕vision token的双重角色——增强(SVC)与抑制(CRC)——在隐表示层协同操作，在LLaVA-1.5上POPE准确率提升约2%，仅增加1.06×推理延迟。 MLLM幻觉的核心机制： 多模态大语言模型(MLLM)生成…
tags:
  - "CVPR 2025"
  - "幻觉检测"
  - "MLLM幻觉"
