...
description: >-
  [ICCV 2025][LLM/NLP][零阶优化] 提出 SubZero（random Subspace Zeroth-order），通过逐层低秩扰动在随机子空间中估计梯度，显著降低零阶优化的梯度方差和角度误差，以接近推理的内存开销实现 LLM 的高效微调。
tags:
  - ICCV 2025
  - LLM/NLP
  - 零阶优化
...
- [\[ACL 2025\] Beyond Demographics: Fine-tuning Large Language Models to Predict Individuals' Subjective Text Perceptions](../../ACL2025/llm_nlp/beyond_demographics_fine-tuning_large_language_models_to_predict_individuals_sub.md)
