...
description: >-
  [ICCV 2025][图像生成][扩散模型] Omegance 提出仅通过一个参数 $\omega$ 缩放扩散模型去噪步骤中的噪声预测，即可无需重训练地实现对生成图像/视频细节粒度的全局、空间和时序精细控制，方法与架构无关且兼容 SDXL、SD3、FLUX 等多种模型。 领域现状：扩散模型已成为高质量图像合成的主流范式…
tags:
  - "ICCV 2025"
  - "图像生成"
  - "扩散模型"
