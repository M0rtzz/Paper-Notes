...
description: >-
  [ICCV 2025][视频理解][事件相机] 首次提出事件相机运动估计与噪声估计的联合方法，利用对比度最大化（CMax）框架中运动补偿后的局部对比度对每个事件评分，通过交替优化同时获得运动参数和信号/噪声分类，在 E-MLB 去噪基准上达到 SOTA。 事件相机是新型视觉传感器，能克服传统相机的运动模糊、有限动态范围等缺陷…
tags:
  - "ICCV 2025"
  - "视频理解"
  - "事件相机"
