...
description: >-
  [ICCV 2025][3D视觉][点云预训练] FVP提出将3D视觉预训练建模为"下一帧点云预测"问题，用条件扩散模型从历史帧点云预测未来帧点云来学习3D视觉表示，在12个真实世界操作任务中将DP3的平均成功率提升28%，达到SOTA水平。 - 当前机器人视觉表示学习主要依赖2D图像预训练（如R3M、MVP、VC-1）…
tags:
  - "ICCV 2025"
  - "3D视觉"
  - "点云预训练"
