...
description: >-
  [ICCV 2025][3D视觉][卷帘快门] 本文提出了一种不需要显式建模相机运动的卷帘快门相对位姿估计方法，仅利用每张图像一条扫描线与直线投影的交点信息来恢复位姿，并为平行线和已知重力方向等特殊场景开发了多种最小求解器。 领域现状：相对位姿估计是计算机视觉中的基础问题，广泛应用于 SfM、SLAM、多视图立体和视觉里程计…
tags:
  - "ICCV 2025"
  - "3D视觉"
  - "卷帘快门"
