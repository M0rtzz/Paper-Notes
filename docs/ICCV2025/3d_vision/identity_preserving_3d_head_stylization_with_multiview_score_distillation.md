...
description: >-
  [3D视觉] 提出基于负对数似然蒸馏(LD)的3D头部风格化框架，通过多视角网格评分、镜像梯度和秩加权评分张量，实现在360度一致渲染下的高质量风格化与身份保持。 3D头部风格化旨在将真实人脸转化为艺术风格表征，广泛应用于游戏和虚拟现实。现有方法主要基于EG3D，仅能生成近正面视图，且依赖SDS（Score Distilla…
tags:
  - "3D视觉"
---
