...
description: >-
  [ICCV2025][自动驾驶][雷达场景流] 提出 TARS，一种交通感知的雷达场景流估计方法，通过联合目标检测构建交通向量场（TVF），在交通层面而非实例层面捕获刚体运动，在 VOD 和专有数据集上分别超越 SOTA 15% 和 23%。 - 场景流为自动驾驶提供关键运动信息，描述两帧点云间的点位移向量 - 现有 LiD…
tags:
  - "ICCV2025"
  - "自动驾驶"
  - "雷达场景流"
