...
description: >-
  [ICCV 2025][人体理解][3D形变模型] imHead 提出首个大规模隐式 3D 头部形变模型，通过全局-局部解耦架构在 4,000 个身份的数据集上训练，实现了紧凑的隐式表示与局部面部编辑的兼顾，在重建精度和编辑灵活性上超越现有方法。 3D 形变模型（3DMM）是人脸建模的核心技术，广泛应用于游戏、图形学和虚拟现…
tags:
  - "ICCV 2025"
  - "人体理解"
  - "3D形变模型"
